...
object OrderApi {
   ...
   * @param text Optional cancellation annotation. e.g. &#39;Spread Exceeded&#39;
   */
  def order.cancelAll(targetAccountIds: Option[String] = None, symbol: Option[String] = None, filter: Option[String] = None, text: Option[String] = None)(implicit apiKey: ApiKeyValue, apiKey: ApiKeyValue, apiKey: ApiKeyValue): ApiRequest[Seq[Order]] =
    ApiRequest[Seq[Order]](ApiMethods.DELETE, "https://www.bitmex.com/api/v1", "/order/all", "application/json")
      .withApiKey(apiKey, "api-expires", HEADER)
      .withApiKey(apiKey, "api-key", HEADER)
      .withApiKey(apiKey, "api-signature", HEADER)
      .withFormParam("targetAccountIds", targetAccountIds)
