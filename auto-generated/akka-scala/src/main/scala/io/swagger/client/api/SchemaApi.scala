...
object SchemaApi {
  ...
  def schema.get(model: Option[String] = None): ApiRequest[Any] =
    ApiRequest[Any](ApiMethods.GET, "https://www.bitmex.com/api/v1", "/schema", "application/json")
  ...
  def schema.websocketHelp(): ApiRequest[Any] =
    ApiRequest[Any](ApiMethods.GET, "https://www.bitmex.com/api/v1", "/schema/websocketHelp", "application/json")
      .withSuccessResponse[Any](200)
      .withErrorResponse[Error](400)
      .withErrorResponse[Error](401)
      .withErrorResponse[Error](403)
