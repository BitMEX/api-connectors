...
case class Position (
  ...
  openingCost: Option[Double] = None,
  openingComm: Option[Double] = None,
  ...
  execBuyQty: Option[Double] = None,
  execBuyCost: Option[Double] = None,
  execSellQty: Option[Double] = None,
  execSellCost: Option[Double] = None,
  execQty: Option[Double] = None,
  execCost: Option[Double] = None,
  execComm: Option[Double] = None,
  currentTimestamp: Option[DateTime] = None,
  ...
  realisedGrossPnl: Option[Double] = None,
  realisedTax: Option[Double] = None,
  realisedPnl: Option[Double] = None,
  unrealisedGrossPnl: Option[Double] = None,
  longBankrupt: Option[Double] = None,
  shortBankrupt: Option[Double] = None,
  taxBase: Option[Double] = None,
  indicativeTaxRate: Option[Double] = None,
  indicativeTax: Option[Double] = None,
  unrealisedTax: Option[Double] = None,
