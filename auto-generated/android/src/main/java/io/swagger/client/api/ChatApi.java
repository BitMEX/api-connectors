...
public class ChatApi {
  ...
  */
  public PinnedMessage chatGetPinnedMessage (Double channelID) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'channelID' is set
    if (channelID == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'channelID' when calling chatGetPinnedMessage",
        new ApiException(400, "Missing the required parameter 'channelID' when calling chatGetPinnedMessage"));
    }

    // create path and map variables
    String path = "/chat/pinned";
    ...
    try {
      String localVarResponse = apiInvoker.invokeAPI (basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames);
      if (localVarResponse != null) {
         return (PinnedMessage) ApiInvoker.deserialize(localVarResponse, "", PinnedMessage.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
   ...
   * @param channelID 
  */
  public void chatGetPinnedMessage (Double channelID, final Response.Listener<PinnedMessage> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/chat/pinned".replaceAll("\\{format\\}","json");
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((PinnedMessage) ApiInvoker.deserialize(localVarResponse,  "", PinnedMessage.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
