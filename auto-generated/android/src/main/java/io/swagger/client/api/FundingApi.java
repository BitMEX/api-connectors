...
public class FundingApi {
  ...
  * 
   ...
   * @return List<Funding>
  */
  public List<Funding> fundingGet (String symbol, String filter, String columns, Integer count, Integer start, Boolean reverse, Date startTime, Date endTime) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
  ...
  */
  public void fundingGet (String symbol, String filter, String columns, Integer count, Integer start, Boolean reverse, Date startTime, Date endTime, final Response.Listener<List<Funding>> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
