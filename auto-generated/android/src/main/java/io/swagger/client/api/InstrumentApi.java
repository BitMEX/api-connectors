...
public class InstrumentApi {
  ...
  */
  public List<StatsUSDBySymbol> instrumentGetUsdVolume (String symbol, String columns) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;

    // create path and map variables
    String path = "/instrument/usdVolume";
    ...
    try {
      String localVarResponse = apiInvoker.invokeAPI (basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames);
      if (localVarResponse != null) {
         return (List<StatsUSDBySymbol>) ApiInvoker.deserialize(localVarResponse, "array", StatsUSDBySymbol.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
   ...
   * Get a summary of exchange statistics in USD.
   * 
   * @param symbol Filter by symbol.   * @param columns Array of column names to fetch.
  */
  public void instrumentGetUsdVolume (String symbol, String columns, final Response.Listener<List<StatsUSDBySymbol>> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;


    // create path and map variables
    String path = "/instrument/usdVolume".replaceAll("\\{format\\}","json");
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((List<StatsUSDBySymbol>) ApiInvoker.deserialize(localVarResponse,  "array", StatsUSDBySymbol.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
