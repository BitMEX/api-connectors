...
public class InsuranceApi {
  ...
  */
  public List<Insurance> insuranceGet (String symbol, String filter, String columns, Integer count, Integer start, Boolean reverse, Date startTime, Date endTime) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
  ...
  */
  public void insuranceGet (String symbol, String filter, String columns, Integer count, Integer start, Boolean reverse, Date startTime, Date endTime, final Response.Listener<List<Insurance>> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
