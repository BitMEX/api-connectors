...
formParams.put("text", ApiInvoker.parameterToString(text));
  ...
  * 
   ...
   * @return List<Order>
  */
  public List<Order> orderCancelAll (String symbol, String filter, String text) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
  ...
  */
  public void orderCancelAll (String symbol, String filter, String text, final Response.Listener<List<Order>> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
