...
public class PositionApi {
  ...
  */
  public List<Position> positionGet (String filter, String columns, Integer count) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
  ...
  */
  public void positionGet (String filter, String columns, Integer count, final Response.Listener<List<Position>> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
...
formParams.put("enabled", ApiInvoker.parameterToString(enabled));
  ...
  * When margin is isolated on a position, use this function to add or remove margin from the position. Note that you cannot remove margin below the initial margin threshold.
   ...
   * @return Position
  */
  public Position positionTransferIsolatedMargin (String symbol, Long amount, Double targetAccountId) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'symbol' is set
    if (symbol == null) {
  ...
  */
  public void positionTransferIsolatedMargin (String symbol, Long amount, Double targetAccountId, final Response.Listener<Position> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
...
formParams.put("targetAccountId", ApiInvoker.parameterToString(targetAccountId));
  ...
  * Risk Limits limit the size of positions you can trade at various margin levels. Larger positions require more margin. Please see the Risk Limit documentation for more details.
   ...
   * @return Position
  */
  public Position positionUpdateRiskLimit (String symbol, Long riskLimit, Double targetAccountId) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'symbol' is set
    if (symbol == null) {
  ...
  */
  public void positionUpdateRiskLimit (String symbol, Long riskLimit, Double targetAccountId, final Response.Listener<Position> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
