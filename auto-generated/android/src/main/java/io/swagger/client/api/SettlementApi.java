...
public class SettlementApi {
  ...
  */
  public List<Settlement> settlementGet (String symbol, String filter, String columns, Integer count, Integer start, Boolean reverse, Date startTime, Date endTime) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
  ...
  */
  public void settlementGet (String symbol, String filter, String columns, Integer count, Integer start, Boolean reverse, Date startTime, Date endTime, final Response.Listener<List<Settlement>> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
