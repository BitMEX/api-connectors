...
public class User {
  ...
  private Date pgpPubKeyCreated = null;
   ...
   **/
  @ApiModelProperty(value = "")
  public Date getPgpPubKeyCreated() {
    return pgpPubKeyCreated;
  }
  public void setPgpPubKeyCreated(Date pgpPubKeyCreated) {
  ...
  public boolean equals(Object o) {
    ...
    return (this.id == null ? user.id == null : this.id.equals(user.id)) &&
        ...
        (this.pgpPubKeyCreated == null ? user.pgpPubKeyCreated == null : this.pgpPubKeyCreated.equals(user.pgpPubKeyCreated)) &&
  ...
  public int hashCode() {
    ...
    result = 31 * result + (this.pgpPubKeyCreated == null ? 0: this.pgpPubKeyCreated.hashCode());
