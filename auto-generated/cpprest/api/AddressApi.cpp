...
pplx::task<std::shared_ptr<Address>> AddressApi::address_new(utility::string_t currency, utility::string_t network, utility::string_t address, utility::string_t name, boost::optional<utility::string_t> note, boost::optional<bool> skipConfirm, boost::optional<bool> skip2FA)
{
