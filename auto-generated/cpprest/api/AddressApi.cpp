...
pplx::task<std::vector<std::shared_ptr<Address>>> AddressApi::address_get()
{


    std::shared_ptr<ApiConfiguration> apiConfiguration( m_ApiClient->getConfiguration() );
    utility::string_t path = utility::conversions::to_string_t("/address");
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("AddressApi->address_get does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("AddressApi->address_get does not consume any supported media type"));
    }
    ...
    .then([=](web::http::http_response response)
    {
        ...
        if (response.status_code() >= 400)
        {
            throw ApiException(response.status_code()
                , utility::conversions::to_string_t("error calling address_get: ") + response.reason_phrase()
        ...
        if(response.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            if( contentType.find(responseHttpContentType) == std::string::npos )
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling address_get: unexpected response type: ") + contentType
                    , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
            }
        }
    ...
    .then([=](utility::string_t response)
    {
        ...
        {
            throw ApiException(500
                , utility::conversions::to_string_t("error calling address_get: unsupported response type"));
        }

        return result;
    });
}
pplx::task<std::shared_ptr<Address>> AddressApi::address_new(utility::string_t currency, utility::string_t network, utility::string_t address, utility::string_t name, boost::optional<utility::string_t> note, boost::optional<bool> skipConfirm, boost::optional<bool> skip2FA, boost::optional<utility::string_t> memo)
{
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("AddressApi->address_new does not produce any supported media type"));
    }
    ...
    if (note)
    {
        formParams[ utility::conversions::to_string_t("note") ] = ApiClient::parameterToString(*note);
    }
    if (skipConfirm)
    {
        formParams[ utility::conversions::to_string_t("skipConfirm") ] = ApiClient::parameterToString(*skipConfirm);
    }
    if (skip2FA)
    {
        formParams[ utility::conversions::to_string_t("skip2FA") ] = ApiClient::parameterToString(*skip2FA);
    }
    if (memo)
    {
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("AddressApi->address_new does not consume any supported media type"));
    }
    ...
    .then([=](web::http::http_response response)
    {
        ...
        {
            throw ApiException(response.status_code()
                , utility::conversions::to_string_t("error calling address_new: ") + response.reason_phrase()
                , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
        }
        ...
        if(response.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling address_new: unexpected response type: ") + contentType
                    , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
            }
        }
    ...
    .then([=](utility::string_t response)
    {
        ...
        {
            throw ApiException(500
                , utility::conversions::to_string_t("error calling address_new: unsupported response type"));
        }
