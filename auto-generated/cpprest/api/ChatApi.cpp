...
pplx::task<std::shared_ptr<PinnedMessage>> ChatApi::chat_getPinnedMessage(double channelID)
{


    std::shared_ptr<ApiConfiguration> apiConfiguration( m_ApiClient->getConfiguration() );
    utility::string_t path = utility::conversions::to_string_t("/chat/pinned");
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("ChatApi->chat_getPinnedMessage does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("ChatApi->chat_getPinnedMessage does not consume any supported media type"));
    }
    ...
    .then([=](web::http::http_response response)
    {
        ...
        {
            throw ApiException(response.status_code()
                , utility::conversions::to_string_t("error calling chat_getPinnedMessage: ") + response.reason_phrase()
                , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
        }
        ...
        if(response.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling chat_getPinnedMessage: unexpected response type: ") + contentType
                    , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
            }
        }
    ...
    .then([=](utility::string_t response)
    {
        std::shared_ptr<PinnedMessage> result(new PinnedMessage());
        ...
        {
            throw ApiException(500
                , utility::conversions::to_string_t("error calling chat_getPinnedMessage: unsupported response type"));
        }
