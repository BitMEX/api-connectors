...
pplx::task<std::shared_ptr<Guild>> GuildApi::guild_edit(utility::string_t name, utility::string_t emoji, double potDistributionPercent, utility::string_t potDistributionType, boost::optional<double> potTraderId, boost::optional<utility::string_t> description, boost::optional<utility::string_t> twitter, boost::optional<utility::string_t> discord, boost::optional<utility::string_t> telegram, boost::optional<utility::string_t> imgUrl, boost::optional<bool> isPrivate)
{
    ...
    if (telegram)
    {
        formParams[ utility::conversions::to_string_t("telegram") ] = ApiClient::parameterToString(*telegram);
    }
    if (imgUrl)
    {
...
pplx::task<std::shared_ptr<Guild>> GuildApi::guild_new(utility::string_t name, utility::string_t emoji, double potDistributionPercent, utility::string_t potDistributionType, boost::optional<utility::string_t> description, boost::optional<utility::string_t> twitter, boost::optional<utility::string_t> discord, boost::optional<utility::string_t> telegram, boost::optional<utility::string_t> imgUrl, boost::optional<bool> isPrivate)
{
