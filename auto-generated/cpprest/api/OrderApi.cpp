...
pplx::task<std::shared_ptr<Order>> OrderApi::order_amend(boost::optional<utility::string_t> orderID, boost::optional<utility::string_t> origClOrdID, boost::optional<utility::string_t> clOrdID, boost::optional<double> simpleOrderQty, boost::optional<int32_t> orderQty, boost::optional<double> simpleLeavesQty, boost::optional<int32_t> leavesQty, boost::optional<double> price, boost::optional<double> stopPx, boost::optional<double> pegOffsetValue, boost::optional<utility::string_t> text)
{
...
pplx::task<std::vector<std::shared_ptr<Order>>> OrderApi::order_cancelAll(boost::optional<utility::string_t> targetAccountIds, boost::optional<utility::string_t> symbol, boost::optional<utility::string_t> filter, boost::optional<utility::string_t> text)
{
    ...
    if (targetAccountIds)
    {
        formParams[ utility::conversions::to_string_t("targetAccountIds") ] = ApiClient::parameterToString(*targetAccountIds);
    }
    if (symbol)
    {
...
pplx::task<std::shared_ptr<Order>> OrderApi::order_new(utility::string_t symbol, boost::optional<utility::string_t> side, boost::optional<double> simpleOrderQty, boost::optional<int32_t> orderQty, boost::optional<double> price, boost::optional<int32_t> displayQty, boost::optional<double> stopPx, boost::optional<utility::string_t> clOrdID, boost::optional<utility::string_t> clOrdLinkID, boost::optional<double> pegOffsetValue, boost::optional<utility::string_t> pegPriceType, boost::optional<utility::string_t> ordType, boost::optional<utility::string_t> timeInForce, boost::optional<utility::string_t> execInst, boost::optional<utility::string_t> contingencyType, boost::optional<utility::string_t> text)
{
