...
#ifndef IO_SWAGGER_CLIENT_API_PorlApi_H_
#define IO_SWAGGER_CLIENT_API_PorlApi_H_
...
{
public:
    PorlApi( std::shared_ptr<ApiClient> apiClient );
    virtual ~PorlApi();
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<Porl>> porl_getNonce(
    );
    /// <summary>
    ...
    /// 
    /// </remarks>
    pplx::task<std::vector<std::shared_ptr<X-any>>> porl_getSnapshots(
    );
...
#endif /* IO_SWAGGER_CLIENT_API_PorlApi_H_ */
