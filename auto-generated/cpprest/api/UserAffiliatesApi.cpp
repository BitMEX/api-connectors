...
UserAffiliatesApi::UserAffiliatesApi( std::shared_ptr<ApiClient> apiClient )
...
pplx::task<std::vector<std::shared_ptr<X-any>>> UserAffiliatesApi::userAffiliates_get(boost::optional<double> depth, boost::optional<double> targetAccountId, boost::optional<double> selectUserId)
{


    std::shared_ptr<ApiConfiguration> apiConfiguration( m_ApiClient->getConfiguration() );
    utility::string_t path = utility::conversions::to_string_t("/userAffiliates");
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("UserAffiliatesApi->userAffiliates_get does not produce any supported media type"));
    }
    ...
    if (selectUserId)
    {
        queryParams[utility::conversions::to_string_t("selectUserId")] = ApiClient::parameterToString(*selectUserId);
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("UserAffiliatesApi->userAffiliates_get does not consume any supported media type"));
    }
    ...
    .then([=](web::http::http_response response)
    {
        ...
        if (response.status_code() >= 400)
        {
            throw ApiException(response.status_code()
                , utility::conversions::to_string_t("error calling userAffiliates_get: ") + response.reason_phrase()
        ...
        if(response.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            if( contentType.find(responseHttpContentType) == std::string::npos )
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling userAffiliates_get: unexpected response type: ") + contentType
                    , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
            }
        }
    ...
    .then([=](utility::string_t response)
    {
        ...
        {
            throw ApiException(500
                , utility::conversions::to_string_t("error calling userAffiliates_get: unsupported response type"));
        }
