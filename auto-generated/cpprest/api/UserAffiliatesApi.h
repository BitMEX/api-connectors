...
#ifndef IO_SWAGGER_CLIENT_API_UserAffiliatesApi_H_
#define IO_SWAGGER_CLIENT_API_UserAffiliatesApi_H_
...
{
public:
    UserAffiliatesApi( std::shared_ptr<ApiClient> apiClient );
    virtual ~UserAffiliatesApi();
    /// <summary>
    ...
    pplx::task<std::vector<std::shared_ptr<X-any>>> userAffiliates_get(
        boost::optional<double> depth,
        boost::optional<double> targetAccountId,
        boost::optional<double> selectUserId
    );
...
#endif /* IO_SWAGGER_CLIENT_API_UserAffiliatesApi_H_ */
