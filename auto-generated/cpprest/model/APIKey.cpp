...
void APIKey::fromJson(web::json::value& val)
{
    ...
    setNonce(ModelBase::int64_tFromJson(val[utility::conversions::to_string_t("nonce")]));
    ...
    if(val.has_field(utility::conversions::to_string_t("targetAccountId")))
    {
        ...
        if(!fieldValue.is_null())
        {
            setTargetAccountId(ModelBase::int32_tFromJson(fieldValue));
        }
    }
    {
        m_Permissions.clear();
...
void APIKey::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    setNonce(ModelBase::int64_tFromHttpContent(multipart->getContent(utility::conversions::to_string_t("nonce"))));
    ...
    {
        setTargetAccountId(ModelBase::int32_tFromHttpContent(multipart->getContent(utility::conversions::to_string_t("targetAccountId"))));
    }
    {
        m_Permissions.clear();
...
int64_t APIKey::getNonce() const
{
    return m_Nonce;
}


void APIKey::setNonce(int64_t value)
{
    m_Nonce = value;
...
int32_t APIKey::getTargetAccountId() const
{
    return m_TargetAccountId;
}


void APIKey::setTargetAccountId(int32_t value)
{
...
int32_t APIKey::getUserId() const
{
    return m_UserId;
}


void APIKey::setUserId(int32_t value)
{
    m_UserId = value;
