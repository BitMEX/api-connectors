...
public:
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<X-any>>& getCidrs();
    bool cidrsIsSet() const;
    void unsetCidrs();
    void setCidrs(std::vector<std::shared_ptr<X-any>> value);
    /// <summary>
    /// 
    /// </summary>
    int32_t getTargetAccountId() const;
    bool targetAccountIdIsSet() const;
    void unsetTargetAccountId();
    void setTargetAccountId(int32_t value);
    /// <summary>
    /// 
    /// </summary>
...
protected:
    ...
    bool m_CidrIsSet;
    std::vector<std::shared_ptr<X-any>> m_Cidrs;
    bool m_CidrsIsSet;
    int32_t m_TargetAccountId;
    bool m_TargetAccountIdIsSet;
