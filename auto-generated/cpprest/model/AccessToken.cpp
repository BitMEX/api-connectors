...
AccessToken::AccessToken()
{
    ...
    m_AuthorizedAccountsIsSet = false;
...
web::json::value AccessToken::toJson() const
{
    ...
    if(m_AuthorizedAccountsIsSet)
    {
        val[utility::conversions::to_string_t("authorizedAccounts")] = ModelBase::toJson(m_AuthorizedAccounts);
    }
...
void AccessToken::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("authorizedAccounts")))
    {
        web::json::value& fieldValue = val[utility::conversions::to_string_t("authorizedAccounts")];
        if(!fieldValue.is_null())
        {
            std::shared_ptr<Object> newItem(nullptr);
            newItem->fromJson(fieldValue);
            setAuthorizedAccounts( newItem );
        }
    }
...
void AccessToken::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_AuthorizedAccountsIsSet)
    {
        if (m_AuthorizedAccounts.get())
        {
            m_AuthorizedAccounts->toMultipart(multipart, utility::conversions::to_string_t("authorizedAccounts."));
        }
...
void AccessToken::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t("authorizedAccounts")))
    {
        if(multipart->hasContent(utility::conversions::to_string_t("authorizedAccounts")))
        {
            std::shared_ptr<Object> newItem(nullptr);
            newItem->fromMultiPart(multipart, utility::conversions::to_string_t("authorizedAccounts."));
            setAuthorizedAccounts( newItem );
        }
    }
...
utility::datetime AccessToken::getUpdated() const
{
    return m_Updated;
}


void AccessToken::setUpdated(utility::datetime value)
{
    m_Updated = value;
    
}
std::shared_ptr<Object> AccessToken::getAuthorizedAccounts() const
{
    return m_AuthorizedAccounts;
}


void AccessToken::setAuthorizedAccounts(std::shared_ptr<Object> value)
{
    m_AuthorizedAccounts = value;
    m_AuthorizedAccountsIsSet = true;
}
bool AccessToken::authorizedAccountsIsSet() const
{
    return m_AuthorizedAccountsIsSet;
}

void AccessToken::unsetAuthorizedAccounts()
{
    m_AuthorizedAccountsIsSet = false;
}
