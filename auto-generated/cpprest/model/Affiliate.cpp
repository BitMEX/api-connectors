...
void Affiliate::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("prevPayout")))
    {
        ...
        {
            setPrevPayout(ModelBase::int64_tFromJson(fieldValue));
        }
    }
    if(val.has_field(utility::conversions::to_string_t("prevTurnover")))
    {
        ...
        if(!fieldValue.is_null())
        {
            setPrevTurnover(ModelBase::int64_tFromJson(fieldValue));
        }
    }
    if(val.has_field(utility::conversions::to_string_t("prevComm")))
    {
        ...
        if(!fieldValue.is_null())
        {
            setPrevComm(ModelBase::int64_tFromJson(fieldValue));
        }
    }
    ...
    if(val.has_field(utility::conversions::to_string_t("execTurnover")))
    {
        ...
        if(!fieldValue.is_null())
        {
            setExecTurnover(ModelBase::int64_tFromJson(fieldValue));
        }
    }
    ...
    if(val.has_field(utility::conversions::to_string_t("totalReferrals")))
    {
        ...
        if(!fieldValue.is_null())
        {
            setTotalReferrals(ModelBase::int64_tFromJson(fieldValue));
        }
    }
    ...
    if(val.has_field(utility::conversions::to_string_t("totalComm")))
    {
        ...
        if(!fieldValue.is_null())
        {
            setTotalComm(ModelBase::int64_tFromJson(fieldValue));
        }
    }
    ...
    if(val.has_field(utility::conversions::to_string_t("pendingPayout")))
    {
        ...
        if(!fieldValue.is_null())
        {
            setPendingPayout(ModelBase::int64_tFromJson(fieldValue));
        }
    }
...
void Affiliate::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    {
        setPrevPayout(ModelBase::int64_tFromHttpContent(multipart->getContent(utility::conversions::to_string_t("prevPayout"))));
    }
    if(multipart->hasContent(utility::conversions::to_string_t("prevTurnover")))
    {
        setPrevTurnover(ModelBase::int64_tFromHttpContent(multipart->getContent(utility::conversions::to_string_t("prevTurnover"))));
    }
    if(multipart->hasContent(utility::conversions::to_string_t("prevComm")))
    {
        setPrevComm(ModelBase::int64_tFromHttpContent(multipart->getContent(utility::conversions::to_string_t("prevComm"))));
    }
    ...
    {
        setExecTurnover(ModelBase::int64_tFromHttpContent(multipart->getContent(utility::conversions::to_string_t("execTurnover"))));
    }
    ...
    {
        setTotalReferrals(ModelBase::int64_tFromHttpContent(multipart->getContent(utility::conversions::to_string_t("totalReferrals"))));
    }
    ...
    {
        setTotalComm(ModelBase::int64_tFromHttpContent(multipart->getContent(utility::conversions::to_string_t("totalComm"))));
    }
    ...
    {
        setPendingPayout(ModelBase::int64_tFromHttpContent(multipart->getContent(utility::conversions::to_string_t("pendingPayout"))));
    }
...
int64_t Affiliate::getAccount() const
{
    return m_Account;
}


void Affiliate::setAccount(int64_t value)
{
    m_Account = value;
...
int64_t Affiliate::getPrevPayout() const
{
    return m_PrevPayout;
}


void Affiliate::setPrevPayout(int64_t value)
{
    m_PrevPayout = value;
...
int64_t Affiliate::getPrevTurnover() const
{
    return m_PrevTurnover;
}


void Affiliate::setPrevTurnover(int64_t value)
{
...
int64_t Affiliate::getPrevComm() const
{
    return m_PrevComm;
}


void Affiliate::setPrevComm(int64_t value)
{
    m_PrevComm = value;
...
int64_t Affiliate::getExecTurnover() const
{
    return m_ExecTurnover;
}


void Affiliate::setExecTurnover(int64_t value)
{
...
int64_t Affiliate::getExecComm() const
{
    return m_ExecComm;
}


void Affiliate::setExecComm(int64_t value)
{
    m_ExecComm = value;
...
int64_t Affiliate::getTotalReferrals() const
{
    return m_TotalReferrals;
}


void Affiliate::setTotalReferrals(int64_t value)
{
...
int64_t Affiliate::getTotalTurnover() const
{
    return m_TotalTurnover;
}


void Affiliate::setTotalTurnover(int64_t value)
{
...
int64_t Affiliate::getTotalComm() const
{
    return m_TotalComm;
}


void Affiliate::setTotalComm(int64_t value)
{
    m_TotalComm = value;
...
int64_t Affiliate::getPendingPayout() const
{
    return m_PendingPayout;
}


void Affiliate::setPendingPayout(int64_t value)
{
