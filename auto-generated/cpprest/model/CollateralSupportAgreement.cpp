...
CollateralSupportAgreement::CollateralSupportAgreement()
{
    ...
    m_MmRatioMarginCall = 0L;
    m_MmRatioMarginCallIsSet = false;
    m_MmRatioLiquidation = 0L;
...
void CollateralSupportAgreement::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("minAmount")))
    {
        ...
        if(!fieldValue.is_null())
        {
            setMinAmount(ModelBase::int64_tFromJson(fieldValue));
        }
    }
    if(val.has_field(utility::conversions::to_string_t("threshold")))
    {
        ...
        if(!fieldValue.is_null())
        {
            setThreshold(ModelBase::int64_tFromJson(fieldValue));
        }
    }
    if(val.has_field(utility::conversions::to_string_t("mmRatioMarginCall")))
    {
        ...
        if(!fieldValue.is_null())
        {
            setMmRatioMarginCall(ModelBase::int64_tFromJson(fieldValue));
        }
    }
    if(val.has_field(utility::conversions::to_string_t("mmRatioLiquidation")))
    {
        ...
        if(!fieldValue.is_null())
        {
            setMmRatioLiquidation(ModelBase::int64_tFromJson(fieldValue));
        }
    }
...
void CollateralSupportAgreement::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    {
        setMinAmount(ModelBase::int64_tFromHttpContent(multipart->getContent(utility::conversions::to_string_t("minAmount"))));
    }
    if(multipart->hasContent(utility::conversions::to_string_t("threshold")))
    {
        setThreshold(ModelBase::int64_tFromHttpContent(multipart->getContent(utility::conversions::to_string_t("threshold"))));
    }
    if(multipart->hasContent(utility::conversions::to_string_t("mmRatioMarginCall")))
    {
        setMmRatioMarginCall(ModelBase::int64_tFromHttpContent(multipart->getContent(utility::conversions::to_string_t("mmRatioMarginCall"))));
    }
    if(multipart->hasContent(utility::conversions::to_string_t("mmRatioLiquidation")))
    {
        setMmRatioLiquidation(ModelBase::int64_tFromHttpContent(multipart->getContent(utility::conversions::to_string_t("mmRatioLiquidation"))));
    }
...
int64_t CollateralSupportAgreement::getAccount() const
{
    return m_Account;
}


void CollateralSupportAgreement::setAccount(int64_t value)
{
    m_Account = value;
    m_AccountIsSet = true;
}
...
int64_t CollateralSupportAgreement::getAmount() const
{
    return m_Amount;
}


void CollateralSupportAgreement::setAmount(int64_t value)
{
    m_Amount = value;
    m_AmountIsSet = true;
}
...
int64_t CollateralSupportAgreement::getMinAmount() const
{
    return m_MinAmount;
}


void CollateralSupportAgreement::setMinAmount(int64_t value)
{
    m_MinAmount = value;
...
int64_t CollateralSupportAgreement::getThreshold() const
{
    return m_Threshold;
}


void CollateralSupportAgreement::setThreshold(int64_t value)
{
    m_Threshold = value;
...
int64_t CollateralSupportAgreement::getMmRatioMarginCall() const
{
    return m_MmRatioMarginCall;
}


void CollateralSupportAgreement::setMmRatioMarginCall(int64_t value)
{
...
int64_t CollateralSupportAgreement::getMmRatioLiquidation() const
{
    return m_MmRatioLiquidation;
}


void CollateralSupportAgreement::setMmRatioLiquidation(int64_t value)
{
