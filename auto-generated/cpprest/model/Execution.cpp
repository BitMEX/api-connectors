...
web::json::value Execution::toJson() const
{
    ...
    if(m_ExecGrossPnlIsSet)
    {
        val[utility::conversions::to_string_t("execGrossPnl")] = ModelBase::toJson(m_ExecGrossPnl);
    }
...
void Execution::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("execGrossPnl")))
    {
        web::json::value& fieldValue = val[utility::conversions::to_string_t("execGrossPnl")];
        if(!fieldValue.is_null())
        {
            setExecGrossPnl(ModelBase::doubleFromJson(fieldValue));
        }
    }
...
void Execution::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_ExecGrossPnlIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t("execGrossPnl"), m_ExecGrossPnl));
    }
    if(m_CurrentQtyIsSet)
    {
...
void Execution::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t("execGrossPnl")))
    {
        setExecGrossPnl(ModelBase::doubleFromHttpContent(multipart->getContent(utility::conversions::to_string_t("execGrossPnl"))));
    }
...
double Execution::getExecGrossPnl() const
{
    return m_ExecGrossPnl;
}


void Execution::setExecGrossPnl(double value)
{
    m_ExecGrossPnl = value;
    m_ExecGrossPnlIsSet = true;
}
bool Execution::execGrossPnlIsSet() const
{
    return m_ExecGrossPnlIsSet;
}

void Execution::unsetExecGrossPnl()
{
    m_ExecGrossPnlIsSet = false;
}

double Execution::getCurrentQty() const
{
    return m_CurrentQty;
}


void Execution::setCurrentQty(double value)
{
    m_CurrentQty = value;
    m_CurrentQtyIsSet = true;
}
bool Execution::currentQtyIsSet() const
{
    return m_CurrentQtyIsSet;
}

void Execution::unsetCurrentQty()
{
    m_CurrentQtyIsSet = false;
}

double Execution::getAvgEntryPrice() const
{
    return m_AvgEntryPrice;
}


void Execution::setAvgEntryPrice(double value)
{
    m_AvgEntryPrice = value;
    m_AvgEntryPriceIsSet = true;
}
bool Execution::avgEntryPriceIsSet() const
{
    return m_AvgEntryPriceIsSet;
}

void Execution::unsetAvgEntryPrice()
{
    m_AvgEntryPriceIsSet = false;
}

double Execution::getRealisedPnl() const
{
    return m_RealisedPnl;
}


void Execution::setRealisedPnl(double value)
{
    m_RealisedPnl = value;
    m_RealisedPnlIsSet = true;
}
bool Execution::realisedPnlIsSet() const
{
    return m_RealisedPnlIsSet;
}

void Execution::unsetRealisedPnl()
{
    m_RealisedPnlIsSet = false;
}

double Execution::getUnrealisedPnl() const
{
    return m_UnrealisedPnl;
}


void Execution::setUnrealisedPnl(double value)
{
    m_UnrealisedPnl = value;
    m_UnrealisedPnlIsSet = true;
}
bool Execution::unrealisedPnlIsSet() const
{
    return m_UnrealisedPnlIsSet;
}

void Execution::unsetUnrealisedPnl()
{
    m_UnrealisedPnlIsSet = false;
}
