...
public:
    ...
    /// 
    /// </summary>
    double getExecGrossPnl() const;
    bool execGrossPnlIsSet() const;
    void unsetExecGrossPnl();
    void setExecGrossPnl(double value);
    /// <summary>
    /// 
    /// </summary>
...
protected:
    ...
    utility::datetime m_Timestamp;
        double m_ExecGrossPnl;
    bool m_ExecGrossPnlIsSet;
    double m_CurrentQty;
