...
#ifndef IO_SWAGGER_CLIENT_MODEL_Funding_H_
#define IO_SWAGGER_CLIENT_MODEL_Funding_H_
...
public:
    ...
    /// 
    /// </summary>
    double getFundingRateDaily() const;
    bool fundingRateDailyIsSet() const;
    void unsetFundingRateDaily();
    void setFundingRateDaily(double value);
...
protected:
    ...
    double m_FundingRateDaily;
    bool m_FundingRateDailyIsSet;
};
...
#endif /* IO_SWAGGER_CLIENT_MODEL_Funding_H_ */
