...
void GlobalNotification::fromJson(web::json::value& val)
{
    ...
    setTtl(ModelBase::int32_tFromJson(val[utility::conversions::to_string_t("ttl")]));
...
int32_t GlobalNotification::getId() const
{
    return m_Id;
}


void GlobalNotification::setId(int32_t value)
{
    m_Id = value;
    m_IdIsSet = true;
}
...
int32_t GlobalNotification::getTtl() const
{
    return m_Ttl;
}


void GlobalNotification::setTtl(int32_t value)
{
    m_Ttl = value;
