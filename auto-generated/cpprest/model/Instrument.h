...
public:
    ...
    /// 
    /// </summary>
    utility::datetime getListedSettle() const;
    bool listedSettleIsSet() const;
    void unsetListedSettle();
    void setListedSettle(utility::datetime value);
    /// <summary>
    /// 
    /// </summary>
    ...
    /// 
    /// </summary>
    int64_t getMaxOrderQty() const;
    bool maxOrderQtyIsSet() const;
    void unsetMaxOrderQty();
    void setMaxOrderQty(int64_t value);
    /// <summary>
    /// 
    /// </summary>
    ...
    /// 
    /// </summary>
    int64_t getLotSize() const;
    bool lotSizeIsSet() const;
    void unsetLotSize();
    void setLotSize(int64_t value);
    /// <summary>
    /// 
    /// </summary>
    ...
    void setMultiplier(int64_t value);
    /// <summary>
    /// 
    /// </summary>
    ...
    /// 
    /// </summary>
    int64_t getUnderlyingToPositionMultiplier() const;
    bool underlyingToPositionMultiplierIsSet() const;
    void unsetUnderlyingToPositionMultiplier();
    void setUnderlyingToPositionMultiplier(int64_t value);
    /// <summary>
    /// 
    /// </summary>
    int64_t getUnderlyingToSettleMultiplier() const;
    bool underlyingToSettleMultiplierIsSet() const;
    void unsetUnderlyingToSettleMultiplier();
    void setUnderlyingToSettleMultiplier(int64_t value);
    /// <summary>
    /// 
    /// </summary>
    int64_t getQuoteToSettleMultiplier() const;
    bool quoteToSettleMultiplierIsSet() const;
    void unsetQuoteToSettleMultiplier();
    void setQuoteToSettleMultiplier(int64_t value);
    /// <summary>
    /// 
    /// </summary>
    ...
    /// 
    /// </summary>
    int64_t getRiskStep() const;
    bool riskStepIsSet() const;
    void unsetRiskStep();
    void setRiskStep(int64_t value);
    /// <summary>
    /// 
    /// </summary>
    ...
    void setTotalVolume(int64_t value);
    /// <summary>
    /// 
    /// </summary>
    ...
    /// 
    /// </summary>
    int64_t getPrevTotalTurnover() const;
    bool prevTotalTurnoverIsSet() const;
    void unsetPrevTotalTurnover();
    void setPrevTotalTurnover(int64_t value);
    /// <summary>
    /// 
    /// </summary>
    ...
    /// 
    /// </summary>
    double getHomeNotional24h() const;
    bool homeNotional24hIsSet() const;
    void unsetHomeNotional24h();
    void setHomeNotional24h(double value);
    /// <summary>
    /// 
    /// </summary>
    double getForeignNotional24h() const;
    bool foreignNotional24hIsSet() const;
    void unsetForeignNotional24h();
    void setForeignNotional24h(double value);
    /// <summary>
    /// 
    /// </summary>
    ...
    /// 
    /// </summary>
    double getSettledPriceAdjustmentRate() const;
    bool settledPriceAdjustmentRateIsSet() const;
    void unsetSettledPriceAdjustmentRate();
    void setSettledPriceAdjustmentRate(double value);
    /// <summary>
    /// 
    /// </summary>
    ...
    /// 
    /// </summary>
    bool isInstantPnl() const;
    bool instantPnlIsSet() const;
    void unsetInstantPnl();
    void setInstantPnl(bool value);
    /// <summary>
    /// 
    /// </summary>
    double getMinTick() const;
    bool minTickIsSet() const;
    void unsetMinTick();
    void setMinTick(double value);
    /// <summary>
    /// 
    /// </summary>
...
protected:
    ...
    bool m_SettleIsSet;
    utility::datetime m_ListedSettle;
    bool m_ListedSettleIsSet;
    ...
    int64_t m_UnderlyingToPositionMultiplier;
    bool m_UnderlyingToPositionMultiplierIsSet;
    int64_t m_UnderlyingToSettleMultiplier;
    bool m_UnderlyingToSettleMultiplierIsSet;
    int64_t m_QuoteToSettleMultiplier;
    ...
    double m_HomeNotional24h;
    bool m_HomeNotional24hIsSet;
    double m_ForeignNotional24h;
    bool m_ForeignNotional24hIsSet;
    ...
    double m_SettledPriceAdjustmentRate;
    bool m_SettledPriceAdjustmentRateIsSet;
    double m_SettledPrice;
    bool m_SettledPriceIsSet;
    bool m_InstantPnl;
    bool m_InstantPnlIsSet;
    double m_MinTick;
    bool m_MinTickIsSet;
