...
void PinnedMessage::fromJson(web::json::value& val)
{
    ...
    setChannelID(ModelBase::int32_tFromJson(val[utility::conversions::to_string_t("channelID")]));
...
void PinnedMessage::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    setChannelID(ModelBase::int32_tFromHttpContent(multipart->getContent(utility::conversions::to_string_t("channelID"))));
...
int32_t PinnedMessage::getId() const
{
    return m_Id;
}


void PinnedMessage::setId(int32_t value)
{
    m_Id = value;
    
}
int32_t PinnedMessage::getChannelID() const
{
    return m_ChannelID;
}


void PinnedMessage::setChannelID(int32_t value)
{
    m_ChannelID = value;
    
}
int32_t PinnedMessage::getMessageId() const
{
    return m_MessageId;
}


void PinnedMessage::setMessageId(int32_t value)
{
    m_MessageId = value;
