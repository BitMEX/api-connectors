...
void Quote::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("bidSize")))
    {
        ...
        {
            setBidSize(ModelBase::int64_tFromJson(fieldValue));
        }
    }
    ...
    if(val.has_field(utility::conversions::to_string_t("askSize")))
    {
        ...
        if(!fieldValue.is_null())
        {
            setAskSize(ModelBase::int64_tFromJson(fieldValue));
        }
    }
}
...
void Quote::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    {
        setBidSize(ModelBase::int64_tFromHttpContent(multipart->getContent(utility::conversions::to_string_t("bidSize"))));
    }
    ...
    {
        setAskSize(ModelBase::int64_tFromHttpContent(multipart->getContent(utility::conversions::to_string_t("askSize"))));
    }
}
...
int64_t Quote::getBidSize() const
{
    return m_BidSize;
}


void Quote::setBidSize(int64_t value)
{
    m_BidSize = value;
    m_BidSizeIsSet = true;
}
...
int64_t Quote::getAskSize() const
{
    return m_AskSize;
}


void Quote::setAskSize(int64_t value)
{
    m_AskSize = value;
    m_AskSizeIsSet = true;
}
