...
#ifndef IO_SWAGGER_CLIENT_MODEL_QuoteValueRatio_H_
#define IO_SWAGGER_CLIENT_MODEL_QuoteValueRatio_H_
...
/// Hourly Quote Value Ratio Statistic
/// </summary>
class  QuoteValueRatio
    : public ModelBase
{
public:
    QuoteValueRatio();
    virtual ~QuoteValueRatio();
    ...
    /// 
    /// </summary>
    double getVolumeXBT() const;
    bool volumeXBTIsSet() const;
    void unsetVolumeXBT();
    void setVolumeXBT(double value);
    /// <summary>
    /// 
    /// </summary>
    double getQVR() const;
...
#endif /* IO_SWAGGER_CLIENT_MODEL_QuoteValueRatio_H_ */
