...
void Settlement::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("bankrupt")))
    {
        ...
        if(!fieldValue.is_null())
        {
            setBankrupt(ModelBase::int64_tFromJson(fieldValue));
        }
    }
    if(val.has_field(utility::conversions::to_string_t("taxBase")))
    {
        ...
        if(!fieldValue.is_null())
        {
            setTaxBase(ModelBase::int64_tFromJson(fieldValue));
        }
    }
...
void Settlement::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    {
        setBankrupt(ModelBase::int64_tFromHttpContent(multipart->getContent(utility::conversions::to_string_t("bankrupt"))));
    }
    if(multipart->hasContent(utility::conversions::to_string_t("taxBase")))
    {
        setTaxBase(ModelBase::int64_tFromHttpContent(multipart->getContent(utility::conversions::to_string_t("taxBase"))));
    }
...
int64_t Settlement::getBankrupt() const
{
    return m_Bankrupt;
}


void Settlement::setBankrupt(int64_t value)
{
    m_Bankrupt = value;
...
int64_t Settlement::getTaxBase() const
{
    return m_TaxBase;
}


void Settlement::setTaxBase(int64_t value)
{
    m_TaxBase = value;
    m_TaxBaseIsSet = true;
}
