...
int64_t Stats::getVolume24h() const
{
    return m_Volume24h;
}


void Stats::setVolume24h(int64_t value)
{
    m_Volume24h = value;
...
int64_t Stats::getTurnover24h() const
{
    return m_Turnover24h;
}


void Stats::setTurnover24h(int64_t value)
{
    m_Turnover24h = value;
...
int64_t Stats::getOpenInterest() const
{
    return m_OpenInterest;
}


void Stats::setOpenInterest(int64_t value)
{
...
int64_t Stats::getOpenValue() const
{
    return m_OpenValue;
}


void Stats::setOpenValue(int64_t value)
{
    m_OpenValue = value;
