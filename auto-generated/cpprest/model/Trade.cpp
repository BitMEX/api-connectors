...
void Trade::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("grossValue")))
    {
        ...
        if(!fieldValue.is_null())
        {
            setGrossValue(ModelBase::int64_tFromJson(fieldValue));
        }
    }
...
void Trade::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    {
        setGrossValue(ModelBase::int64_tFromHttpContent(multipart->getContent(utility::conversions::to_string_t("grossValue"))));
    }
...
int64_t Trade::getSize() const
{
    return m_Size;
}


void Trade::setSize(int64_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}
...
int64_t Trade::getGrossValue() const
{
    return m_GrossValue;
}


void Trade::setGrossValue(int64_t value)
{
    m_GrossValue = value;
