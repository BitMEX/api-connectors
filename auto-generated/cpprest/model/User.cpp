...
User::User()
{
    ...
    m_PgpPubKeyCreated = utility::datetime();
    m_PgpPubKeyCreatedIsSet = false;
...
web::json::value User::toJson() const
{
    ...
    if(m_PgpPubKeyCreatedIsSet)
    {
        val[utility::conversions::to_string_t("pgpPubKeyCreated")] = ModelBase::toJson(m_PgpPubKeyCreated);
    }
    if(m_CountryIsSet)
    {
...
void User::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("pgpPubKeyCreated")))
    {
        web::json::value& fieldValue = val[utility::conversions::to_string_t("pgpPubKeyCreated")];
        if(!fieldValue.is_null())
        {
            setPgpPubKeyCreated(ModelBase::dateFromJson(fieldValue));
        }
    }
...
void User::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_PgpPubKeyCreatedIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t("pgpPubKeyCreated"), m_PgpPubKeyCreated));
...
void User::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t("pgpPubKeyCreated")))
    {
        setPgpPubKeyCreated(ModelBase::dateFromHttpContent(multipart->getContent(utility::conversions::to_string_t("pgpPubKeyCreated"))));
    }
...
utility::datetime User::getPgpPubKeyCreated() const
{
    return m_PgpPubKeyCreated;
}


void User::setPgpPubKeyCreated(utility::datetime value)
{
    m_PgpPubKeyCreated = value;
    m_PgpPubKeyCreatedIsSet = true;
}
bool User::pgpPubKeyCreatedIsSet() const
{
    return m_PgpPubKeyCreatedIsSet;
}

void User::unsetPgpPubKeyCreated()
{
    m_PgpPubKeyCreatedIsSet = false;
}
