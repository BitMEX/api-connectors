...
public:
    ...
    /// 
    /// </summary>
    utility::datetime getPgpPubKeyCreated() const;
    bool pgpPubKeyCreatedIsSet() const;
    void unsetPgpPubKeyCreated();
    void setPgpPubKeyCreated(utility::datetime value);
    /// <summary>
    /// 
    /// </summary>
...
protected:
    ...
    utility::datetime m_PgpPubKeyCreated;
    bool m_PgpPubKeyCreatedIsSet;
