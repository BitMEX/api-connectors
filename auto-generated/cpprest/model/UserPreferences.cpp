...
UserPreferences::UserPreferences()
{
    ...
    m_FavouriteBotsIsSet = false;
    m_HasSetTradingCurrencies = false;
    m_HasSetTradingCurrenciesIsSet = false;
    ...
    m_HidePnlInGuilds = false;
    m_HidePnlInGuildsIsSet = false;
    m_HideRoiInGuilds = false;
    m_HideRoiInGuildsIsSet = false;
    ...
    m_MobileLocale = utility::conversions::to_string_t("");
    m_MobileLocaleIsSet = false;
    m_MsgsSeenIsSet = false;
    m_NotificationsIsSet = false;
    m_OptionsBeta = false;
    m_OptionsBetaIsSet = false;
    ...
    m_SoundsIsSet = false;
    m_SpacingPreference = utility::conversions::to_string_t("");
    m_SpacingPreferenceIsSet = false;
...
web::json::value UserPreferences::toJson() const
{
    ...
    {
        std::vector<web::json::value> jsonArray;
        for( auto& item : m_FavouriteBots )
        {
            jsonArray.push_back(ModelBase::toJson(item));
        }
        if(jsonArray.size() > 0)
        {
            val[utility::conversions::to_string_t("favouriteBots")] = web::json::value::array(jsonArray);
        }
    }
    if(m_HasSetTradingCurrenciesIsSet)
    {
        val[utility::conversions::to_string_t("hasSetTradingCurrencies")] = ModelBase::toJson(m_HasSetTradingCurrencies);
    }
    {
        std::vector<web::json::value> jsonArray;
    ...
    if(m_HidePnlInGuildsIsSet)
    {
        val[utility::conversions::to_string_t("hidePnlInGuilds")] = ModelBase::toJson(m_HidePnlInGuilds);
    }
    if(m_HideRoiInGuildsIsSet)
    {
        val[utility::conversions::to_string_t("hideRoiInGuilds")] = ModelBase::toJson(m_HideRoiInGuilds);
    }
    {
        std::vector<web::json::value> jsonArray;
    ...
    if(m_MobileLocaleIsSet)
    {
        val[utility::conversions::to_string_t("mobileLocale")] = ModelBase::toJson(m_MobileLocale);
    }
    {
        std::vector<web::json::value> jsonArray;
    ...
    if(m_OptionsBetaIsSet)
    {
        val[utility::conversions::to_string_t("optionsBeta")] = ModelBase::toJson(m_OptionsBeta);
    }
    ...
    if(m_SpacingPreferenceIsSet)
    {
        val[utility::conversions::to_string_t("spacingPreference")] = ModelBase::toJson(m_SpacingPreference);
    }
...
void UserPreferences::fromJson(web::json::value& val)
{
    ...
    {
        m_FavouriteBots.clear();
        std::vector<web::json::value> jsonArray;
        if(val.has_field(utility::conversions::to_string_t("favouriteBots")))
        {
        for( auto& item : val[utility::conversions::to_string_t("favouriteBots")].as_array() )
        {
            m_FavouriteBots.push_back(ModelBase::stringFromJson(item));
        }
        }
    }
    if(val.has_field(utility::conversions::to_string_t("hasSetTradingCurrencies")))
    {
        web::json::value& fieldValue = val[utility::conversions::to_string_t("hasSetTradingCurrencies")];
        if(!fieldValue.is_null())
        {
            setHasSetTradingCurrencies(ModelBase::boolFromJson(fieldValue));
        }
    }
    {
    ...
    if(val.has_field(utility::conversions::to_string_t("hidePnlInGuilds")))
    {
        web::json::value& fieldValue = val[utility::conversions::to_string_t("hidePnlInGuilds")];
        if(!fieldValue.is_null())
        {
            setHidePnlInGuilds(ModelBase::boolFromJson(fieldValue));
        }
    }
    if(val.has_field(utility::conversions::to_string_t("hideRoiInGuilds")))
    {
        web::json::value& fieldValue = val[utility::conversions::to_string_t("hideRoiInGuilds")];
        if(!fieldValue.is_null())
        {
            setHideRoiInGuilds(ModelBase::boolFromJson(fieldValue));
        }
    }
    {
    ...
    if(val.has_field(utility::conversions::to_string_t("mobileLocale")))
    {
        web::json::value& fieldValue = val[utility::conversions::to_string_t("mobileLocale")];
        if(!fieldValue.is_null())
        {
            setMobileLocale(ModelBase::stringFromJson(fieldValue));
        }
    }
    {
        m_MsgsSeen.clear();
    ...
    if(val.has_field(utility::conversions::to_string_t("optionsBeta")))
    {
        web::json::value& fieldValue = val[utility::conversions::to_string_t("optionsBeta")];
        if(!fieldValue.is_null())
        {
            setOptionsBeta(ModelBase::boolFromJson(fieldValue));
        }
    }
    ...
    if(val.has_field(utility::conversions::to_string_t("spacingPreference")))
    {
        web::json::value& fieldValue = val[utility::conversions::to_string_t("spacingPreference")];
        if(!fieldValue.is_null())
        {
            setSpacingPreference(ModelBase::stringFromJson(fieldValue));
        }
    }
...
void UserPreferences::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    }
    {
        ...
        if(jsonArray.size() > 0)
        {
            multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t("favouriteBots"), web::json::value::array(jsonArray), utility::conversions::to_string_t("application/json")));
        }
    }
    if(m_HasSetTradingCurrenciesIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t("hasSetTradingCurrencies"), m_HasSetTradingCurrencies));
    }
    {
        std::vector<web::json::value> jsonArray;
        for( auto& item : m_HideConfirmDialogs )
    ...
    if(m_HidePnlInGuildsIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t("hidePnlInGuilds"), m_HidePnlInGuilds));
    }
    if(m_HideRoiInGuildsIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t("hideRoiInGuilds"), m_HideRoiInGuilds));
    }
    {
        std::vector<web::json::value> jsonArray;
        for( auto& item : m_HideNotifications )
    ...
    if(m_MobileLocaleIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t("mobileLocale"), m_MobileLocale));
    ...
    if(m_OptionsBetaIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t("optionsBeta"), m_OptionsBeta));
    }
    if(m_OrderBookBinningIsSet)
    {
    ...
    if(m_SpacingPreferenceIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t("spacingPreference"), m_SpacingPreference));
...
void UserPreferences::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    {
        m_FavouriteBots.clear();
        if(multipart->hasContent(utility::conversions::to_string_t("favouriteBots")))
        {

        web::json::value jsonArray = web::json::value::parse(ModelBase::stringFromHttpContent(multipart->getContent(utility::conversions::to_string_t("favouriteBots"))));
        for( auto& item : jsonArray.as_array() )
        {
            m_FavouriteBots.push_back(ModelBase::stringFromJson(item));
        }
    ...
    if(multipart->hasContent(utility::conversions::to_string_t("hasSetTradingCurrencies")))
    {
        setHasSetTradingCurrencies(ModelBase::boolFromHttpContent(multipart->getContent(utility::conversions::to_string_t("hasSetTradingCurrencies"))));
    }
    {
        m_HideConfirmDialogs.clear();
    ...
    if(multipart->hasContent(utility::conversions::to_string_t("hidePnlInGuilds")))
    {
        setHidePnlInGuilds(ModelBase::boolFromHttpContent(multipart->getContent(utility::conversions::to_string_t("hidePnlInGuilds"))));
    }
    if(multipart->hasContent(utility::conversions::to_string_t("hideRoiInGuilds")))
    {
        setHideRoiInGuilds(ModelBase::boolFromHttpContent(multipart->getContent(utility::conversions::to_string_t("hideRoiInGuilds"))));
    }
    {
        m_HideNotifications.clear();
    ...
    if(multipart->hasContent(utility::conversions::to_string_t("mobileLocale")))
    {
        setMobileLocale(ModelBase::stringFromHttpContent(multipart->getContent(utility::conversions::to_string_t("mobileLocale"))));
    }
    {
        m_MsgsSeen.clear();
    ...
    if(multipart->hasContent(utility::conversions::to_string_t("optionsBeta")))
    {
        setOptionsBeta(ModelBase::boolFromHttpContent(multipart->getContent(utility::conversions::to_string_t("optionsBeta"))));
    }
    ...
    if(multipart->hasContent(utility::conversions::to_string_t("spacingPreference")))
    {
        setSpacingPreference(ModelBase::stringFromHttpContent(multipart->getContent(utility::conversions::to_string_t("spacingPreference"))));
    }
...
std::vector<utility::string_t>& UserPreferences::getFavouriteBots()
{
    return m_FavouriteBots;
}

void UserPreferences::setFavouriteBots(std::vector<utility::string_t> value)
{
    m_FavouriteBots = value;
    m_FavouriteBotsIsSet = true;
}
bool UserPreferences::favouriteBotsIsSet() const
{
    return m_FavouriteBotsIsSet;
}

void UserPreferences::unsetFavouriteBots()
{
    m_FavouriteBotsIsSet = false;
}

bool UserPreferences::isHasSetTradingCurrencies() const
{
    return m_HasSetTradingCurrencies;
}


void UserPreferences::setHasSetTradingCurrencies(bool value)
{
    m_HasSetTradingCurrencies = value;
    m_HasSetTradingCurrenciesIsSet = true;
}
bool UserPreferences::hasSetTradingCurrenciesIsSet() const
{
    return m_HasSetTradingCurrenciesIsSet;
}

void UserPreferences::unsetHasSetTradingCurrencies()
{
    m_HasSetTradingCurrenciesIsSet = false;
}
...
bool UserPreferences::isHidePnlInGuilds() const
{
    return m_HidePnlInGuilds;
}


void UserPreferences::setHidePnlInGuilds(bool value)
{
    m_HidePnlInGuilds = value;
    m_HidePnlInGuildsIsSet = true;
}
bool UserPreferences::hidePnlInGuildsIsSet() const
{
    return m_HidePnlInGuildsIsSet;
}

void UserPreferences::unsetHidePnlInGuilds()
{
    m_HidePnlInGuildsIsSet = false;
}

bool UserPreferences::isHideRoiInGuilds() const
{
    return m_HideRoiInGuilds;
}


void UserPreferences::setHideRoiInGuilds(bool value)
{
    m_HideRoiInGuilds = value;
    m_HideRoiInGuildsIsSet = true;
}
bool UserPreferences::hideRoiInGuildsIsSet() const
{
    return m_HideRoiInGuildsIsSet;
}

void UserPreferences::unsetHideRoiInGuilds()
{
    m_HideRoiInGuildsIsSet = false;
}
...
utility::string_t UserPreferences::getMobileLocale() const
{
    return m_MobileLocale;
}


void UserPreferences::setMobileLocale(utility::string_t value)
{
    m_MobileLocale = value;
    m_MobileLocaleIsSet = true;
}
bool UserPreferences::mobileLocaleIsSet() const
{
    return m_MobileLocaleIsSet;
}

void UserPreferences::unsetMobileLocale()
{
    m_MobileLocaleIsSet = false;
}
...
bool UserPreferences::isOptionsBeta() const
{
    return m_OptionsBeta;
}


void UserPreferences::setOptionsBeta(bool value)
{
    m_OptionsBeta = value;
    m_OptionsBetaIsSet = true;
}
bool UserPreferences::optionsBetaIsSet() const
{
    return m_OptionsBetaIsSet;
}

void UserPreferences::unsetOptionsBeta()
{
    m_OptionsBetaIsSet = false;
}
...
utility::string_t UserPreferences::getSpacingPreference() const
{
    return m_SpacingPreference;
}


void UserPreferences::setSpacingPreference(utility::string_t value)
{
    m_SpacingPreference = value;
    m_SpacingPreferenceIsSet = true;
}
bool UserPreferences::spacingPreferenceIsSet() const
{
    return m_SpacingPreferenceIsSet;
}

void UserPreferences::unsetSpacingPreference()
{
    m_SpacingPreferenceIsSet = false;
}
