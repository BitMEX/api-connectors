...
namespace Example
{
    public class SettlementGetExample
    {
        public void main()
        {
            var apiInstance = new SettlementApi();
            ...
            {
                Debug.Print("Exception when calling SettlementApi.SettlementGet: " + e.Message );
            }
        }
    }
}
