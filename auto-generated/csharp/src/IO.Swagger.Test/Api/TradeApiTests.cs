...
namespace IO.Swagger.Test
{
    ...
    public class TradeApiTests
    {
        ...
        public void TradeGetTest()
        {
            ...
            //var response = instance.TradeGet(symbol, filter, columns, count, start, reverse, startTime, endTime);
            //Assert.IsInstanceOf<List<Trade>> (response, "response is List<Trade>");
        }
        
        /// <summary>
        /// Test TradeGetBucketed
        /// </summary>
        [Test]
        public void TradeGetBucketedTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string binSize = null;
            //bool? partial = null;
            ...
            //DateTime? startTime = null;
            //DateTime? endTime = null;
            //var response = instance.TradeGetBucketed(binSize, partial, symbol, filter, columns, count, start, reverse, startTime, endTime);
            //Assert.IsInstanceOf<List<TradeBin>> (response, "response is List<TradeBin>");
        }
