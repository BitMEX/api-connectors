...
namespace IO.Swagger.Model
{
    ...
    public partial class DepositAddress :  IEquatable<DepositAddress>, IValidatableObject
    {
        ...
        public DepositAddress(string address = default(string), string memo = default(string))
        {
            // to ensure "address" is required (not null)
            if (address == null)
            {
                throw new InvalidDataException("address is a required property for DepositAddress and cannot be null");
            }
            else
            {
