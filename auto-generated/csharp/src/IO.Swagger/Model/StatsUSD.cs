...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class StatsUSD :  IEquatable<StatsUSD>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as StatsUSD);
        }

        /// <summary>
        /// Returns true if StatsUSD instances are equal
        /// </summary>
        /// <param name="input">Instance of StatsUSD to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StatsUSD input)
        {
            if (input == null)
                return false;
