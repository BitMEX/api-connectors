...
namespace IO.Swagger.Model
{
    ...
    public partial class StatsUSDBySymbol :  IEquatable<StatsUSDBySymbol>, IValidatableObject
    {
        ...
        public StatsUSDBySymbol(string symbol = default(string), string currency = default(string), long? turnover24h = default(long?), long? turnover30d = default(long?), long? turnover365d = default(long?), long? turnover = default(long?))
        {
