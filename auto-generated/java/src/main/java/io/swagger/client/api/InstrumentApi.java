...
public class InstrumentApi {
    ...
    private com.squareup.okhttp.Call instrumentGetValidateBeforeCall(String symbol, String filter, String columns, Integer count, Integer start, Boolean reverse, OffsetDateTime startTime, OffsetDateTime endTime, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     */
    public List<Instrument> instrumentGet(String symbol, String filter, String columns, Integer count, Integer start, Boolean reverse, OffsetDateTime startTime, OffsetDateTime endTime) throws ApiException {
        ApiResponse<List<Instrument>> resp = instrumentGetWithHttpInfo(symbol, filter, columns, count, start, reverse, startTime, endTime);
        return resp.getData();
    }
     ...
     * @param startTime Starting date filter for results. (optional)
     * @param endTime Ending date filter for results. (optional)
     * @return ApiResponse&lt;List&lt;Instrument&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<Instrument>> instrumentGetWithHttpInfo(String symbol, String filter, String columns, Integer count, Integer start, Boolean reverse, OffsetDateTime startTime, OffsetDateTime endTime) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<List<Instrument>>(){}.getType();
     ...
     */
    public com.squareup.okhttp.Call instrumentGetAsync(String symbol, String filter, String columns, Integer count, Integer start, Boolean reverse, OffsetDateTime startTime, OffsetDateTime endTime, final ApiCallback<List<Instrument>> callback) throws ApiException {
    ...
    public List<Instrument> instrumentGetActive() throws ApiException {
        ApiResponse<List<Instrument>> resp = instrumentGetActiveWithHttpInfo();
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<Instrument>> instrumentGetActiveWithHttpInfo() throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call instrumentGetActiveAsync(final ApiCallback<List<Instrument>> callback) throws ApiException {
    ...
    public List<Instrument> instrumentGetActiveAndIndices() throws ApiException {
        ApiResponse<List<Instrument>> resp = instrumentGetActiveAndIndicesWithHttpInfo();
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<Instrument>> instrumentGetActiveAndIndicesWithHttpInfo() throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call instrumentGetActiveAndIndicesAsync(final ApiCallback<List<Instrument>> callback) throws ApiException {
    ...
    public InstrumentInterval instrumentGetActiveIntervals() throws ApiException {
        ApiResponse<InstrumentInterval> resp = instrumentGetActiveIntervalsWithHttpInfo();
        return resp.getData();
    }
     ...
     * Return all active contract series and interval pairs.
     * This endpoint is useful for determining which pairs are live. It returns two arrays of   strings. The first is intervals, such as &#x60;[\&quot;XBT:perpetual\&quot;, \&quot;XBT:quarterly\&quot;, \&quot;XBT:biquarterly\&quot;, \&quot;ETH:quarterly\&quot;, ...]&#x60;. These identifiers are usable in any query&#39;s &#x60;symbol&#x60; param. The second array is the current resolution of these intervals. Results are mapped at the same index.
     * @return ApiResponse&lt;InstrumentInterval&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<InstrumentInterval> instrumentGetActiveIntervalsWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = instrumentGetActiveIntervalsValidateBeforeCall(null, null);
        Type localVarReturnType = new TypeToken<InstrumentInterval>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call instrumentGetActiveIntervalsAsync(final ApiCallback<InstrumentInterval> callback) throws ApiException {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call instrumentGetCompositeIndexCall(String symbol, String filter, String columns, Integer count, Integer start, Boolean reverse, OffsetDateTime startTime, OffsetDateTime endTime, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call instrumentGetCompositeIndexValidateBeforeCall(String symbol, String filter, String columns, Integer count, Integer start, Boolean reverse, OffsetDateTime startTime, OffsetDateTime endTime, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = instrumentGetCompositeIndexCall(symbol, filter, columns, count, start, reverse, startTime, endTime, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<IndexComposite> instrumentGetCompositeIndex(String symbol, String filter, String columns, Integer count, Integer start, Boolean reverse, OffsetDateTime startTime, OffsetDateTime endTime) throws ApiException {
        ApiResponse<List<IndexComposite>> resp = instrumentGetCompositeIndexWithHttpInfo(symbol, filter, columns, count, start, reverse, startTime, endTime);
        return resp.getData();
    }
     ...
     * @param startTime Starting date filter for results. (optional)
     * @param endTime Ending date filter for results. (optional)
     * @return ApiResponse&lt;List&lt;IndexComposite&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<IndexComposite>> instrumentGetCompositeIndexWithHttpInfo(String symbol, String filter, String columns, Integer count, Integer start, Boolean reverse, OffsetDateTime startTime, OffsetDateTime endTime) throws ApiException {
        com.squareup.okhttp.Call call = instrumentGetCompositeIndexValidateBeforeCall(symbol, filter, columns, count, start, reverse, startTime, endTime, null, null);
        Type localVarReturnType = new TypeToken<List<IndexComposite>>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call instrumentGetCompositeIndexAsync(String symbol, String filter, String columns, Integer count, Integer start, Boolean reverse, OffsetDateTime startTime, OffsetDateTime endTime, final ApiCallback<List<IndexComposite>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = instrumentGetCompositeIndexValidateBeforeCall(symbol, filter, columns, count, start, reverse, startTime, endTime, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<IndexComposite>>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    ...
    public List<Instrument> instrumentGetIndices() throws ApiException {
        ApiResponse<List<Instrument>> resp = instrumentGetIndicesWithHttpInfo();
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<Instrument>> instrumentGetIndicesWithHttpInfo() throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call instrumentGetIndicesAsync(final ApiCallback<List<Instrument>> callback) throws ApiException {
    ...
    /**
     * Build call for instrumentGetUsdVolume
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call instrumentGetUsdVolumeCall(String symbol, String columns, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/instrument/usdVolume";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call instrumentGetUsdVolumeValidateBeforeCall(String symbol, String columns, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = instrumentGetUsdVolumeCall(symbol, columns, progressListener, progressRequestListener);
        return call;
     ...
     * @param symbol Filter by symbol. (optional)
     * @param columns Array of column names to fetch. (optional)
     * @return List&lt;StatsUSDBySymbol&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<StatsUSDBySymbol> instrumentGetUsdVolume(String symbol, String columns) throws ApiException {
        ApiResponse<List<StatsUSDBySymbol>> resp = instrumentGetUsdVolumeWithHttpInfo(symbol, columns);
        return resp.getData();
    }
     ...
     * @param symbol Filter by symbol. (optional)
     * @param columns Array of column names to fetch. (optional)
     * @return ApiResponse&lt;List&lt;StatsUSDBySymbol&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<StatsUSDBySymbol>> instrumentGetUsdVolumeWithHttpInfo(String symbol, String columns) throws ApiException {
        com.squareup.okhttp.Call call = instrumentGetUsdVolumeValidateBeforeCall(symbol, columns, null, null);
        Type localVarReturnType = new TypeToken<List<StatsUSDBySymbol>>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call instrumentGetUsdVolumeAsync(String symbol, String columns, final ApiCallback<List<StatsUSDBySymbol>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = instrumentGetUsdVolumeValidateBeforeCall(symbol, columns, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<StatsUSDBySymbol>>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
