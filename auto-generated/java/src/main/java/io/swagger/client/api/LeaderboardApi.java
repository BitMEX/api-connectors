...
public class LeaderboardApi {
    ...
    public List<Leaderboard> leaderboardGet(String method) throws ApiException {
        ApiResponse<List<Leaderboard>> resp = leaderboardGetWithHttpInfo(method);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<Leaderboard>> leaderboardGetWithHttpInfo(String method) throws ApiException {
     ...
     */
    public com.squareup.okhttp.Call leaderboardGetAsync(String method, final ApiCallback<List<Leaderboard>> callback) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public InlineResponse2001 leaderboardGetName() throws ApiException {
        ApiResponse<InlineResponse2001> resp = leaderboardGetNameWithHttpInfo();
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<InlineResponse2001> leaderboardGetNameWithHttpInfo() throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call leaderboardGetNameAsync(final ApiCallback<InlineResponse2001> callback) throws ApiException {
