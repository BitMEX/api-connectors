...
public class OrderBookApi {
     ...
     */
    public com.squareup.okhttp.Call orderBookGetCall(String symbol, BigDecimal depth, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call orderBookGetValidateBeforeCall(String symbol, BigDecimal depth, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'symbol' is set
        if (symbol == null) {
            throw new ApiException("Missing the required parameter 'symbol' when calling orderBookGet(Async)");
        }
        
        
        com.squareup.okhttp.Call call = orderBookGetCall(symbol, depth, progressListener, progressRequestListener);
        return call;
    ...
    public List<OrderBook> orderBookGet(String symbol, BigDecimal depth) throws ApiException {
        ApiResponse<List<OrderBook>> resp = orderBookGetWithHttpInfo(symbol, depth);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<OrderBook>> orderBookGetWithHttpInfo(String symbol, BigDecimal depth) throws ApiException {
        com.squareup.okhttp.Call call = orderBookGetValidateBeforeCall(symbol, depth, null, null);
     ...
     */
    public com.squareup.okhttp.Call orderBookGetAsync(String symbol, BigDecimal depth, final ApiCallback<List<OrderBook>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = orderBookGetValidateBeforeCall(symbol, depth, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<OrderBook>>(){}.getType();
