...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Chat', 'model/ChatChannel', 'model/ConnectedUsers', 'model/Error', 'model/PinnedMessage'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/Chat'), require('../model/ChatChannel'), require('../model/ConnectedUsers'), require('../model/Error'), require('../model/PinnedMessage'));
  } else {
    // Browser globals (root is window)
    if (!root.BitMexApi) {
      root.BitMexApi = {};
    }
    root.BitMexApi.ChatApi = factory(root.BitMexApi.ApiClient, root.BitMexApi.Chat, root.BitMexApi.ChatChannel, root.BitMexApi.ConnectedUsers, root.BitMexApi.Error, root.BitMexApi.PinnedMessage);
  }
}(this, function(ApiClient, Chat, ChatChannel, ConnectedUsers, Error, PinnedMessage) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {Number} opts.channelID Channel id. GET /chat/channels for ids. Global English by default (default to 1)
    ...
    /**
     * Callback function to receive the result of the chatGetPinnedMessage operation.
     * @callback module:api/ChatApi~chatGetPinnedMessageCallback
     * @param {String} error Error message, if any.
     * @param {module:model/PinnedMessage} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/ChatApi~chatGetPinnedMessageCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/PinnedMessage}
     */
    this.chatGetPinnedMessage = function(channelID, callback) {
      var postBody = null;

      // verify the required parameter 'channelID' is set
      if (channelID === undefined || channelID === null) {
        throw new Error("Missing the required parameter 'channelID' when calling chatGetPinnedMessage");
      }
