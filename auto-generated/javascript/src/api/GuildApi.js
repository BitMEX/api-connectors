...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @param {String} potDistributionType How the pot should be distributed to the guild members, must be one of the following: ROLL_OVER, TOP_3, TOP_5, TOP_10, VOLUME_PERCENTAGE, TOP_3_BY_ADV, TOP_5_BY_ADV, TOP_10_BY_ADV, TOP_3_BY_ROI, TOP_5_BY_ROI, TOP_10_BY_ROI, RANDOM
     ...
     * @param {String} opts.telegram Guild telegram link.
