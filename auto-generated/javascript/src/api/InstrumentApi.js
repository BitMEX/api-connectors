...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Error', 'model/IndexComposite', 'model/Instrument', 'model/InstrumentInterval'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/Error'), require('../model/IndexComposite'), require('../model/Instrument'), require('../model/InstrumentInterval'));
  } else {
    // Browser globals (root is window)
    if (!root.BitMexApi) {
      root.BitMexApi = {};
    }
    root.BitMexApi.InstrumentApi = factory(root.BitMexApi.ApiClient, root.BitMexApi.Error, root.BitMexApi.IndexComposite, root.BitMexApi.Instrument, root.BitMexApi.InstrumentInterval);
  }
}(this, function(ApiClient, Error, IndexComposite, Instrument, InstrumentInterval) {
  'use strict';
