...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @param {Number} opts.targetAccountId AccountId of Sub-Affiliate Account
     * @param {Number} opts.selectUserId User id of result array to keep
    ...
    this.userAffiliatesGet = function(opts, callback) {
      ...
      var queryParams = {
        ...
        'selectUserId': opts['selectUserId'],
      };
