...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AccessToken', 'model/Affiliate', 'model/CollateralSupportAgreement', 'model/CommunicationToken', 'model/DepositAddress', 'model/Error', 'model/Execution', 'model/Margin', 'model/QuoteFillRatio', 'model/QuoteValueRatio', 'model/StakingRecord', 'model/TradingVolume', 'model/Transaction', 'model/User', 'model/UserCommissionsBySymbol', 'model/Wallet', 'model/WalletSummaryRecord', 'model/XAny'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/AccessToken'), require('../model/Affiliate'), require('../model/CollateralSupportAgreement'), require('../model/CommunicationToken'), require('../model/DepositAddress'), require('../model/Error'), require('../model/Execution'), require('../model/Margin'), require('../model/QuoteFillRatio'), require('../model/QuoteValueRatio'), require('../model/StakingRecord'), require('../model/TradingVolume'), require('../model/Transaction'), require('../model/User'), require('../model/UserCommissionsBySymbol'), require('../model/Wallet'), require('../model/WalletSummaryRecord'), require('../model/XAny'));
  } else {
    // Browser globals (root is window)
    if (!root.BitMexApi) {
      root.BitMexApi = {};
    }
    root.BitMexApi.UserApi = factory(root.BitMexApi.ApiClient, root.BitMexApi.AccessToken, root.BitMexApi.Affiliate, root.BitMexApi.CollateralSupportAgreement, root.BitMexApi.CommunicationToken, root.BitMexApi.DepositAddress, root.BitMexApi.Error, root.BitMexApi.Execution, root.BitMexApi.Margin, root.BitMexApi.QuoteFillRatio, root.BitMexApi.QuoteValueRatio, root.BitMexApi.StakingRecord, root.BitMexApi.TradingVolume, root.BitMexApi.Transaction, root.BitMexApi.User, root.BitMexApi.UserCommissionsBySymbol, root.BitMexApi.Wallet, root.BitMexApi.WalletSummaryRecord, root.BitMexApi.XAny);
  }
}(this, function(ApiClient, AccessToken, Affiliate, CollateralSupportAgreement, CommunicationToken, DepositAddress, Error, Execution, Margin, QuoteFillRatio, QuoteValueRatio, StakingRecord, TradingVolume, Transaction, User, UserCommissionsBySymbol, Wallet, WalletSummaryRecord, XAny) {
  'use strict';
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the userCancelPendingWithdrawal operation.
     * @callback module:api/UserApi~userCancelPendingWithdrawalCallback
     ...
     * @param {module:api/UserApi~userCancelPendingWithdrawalCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Object}
     */
    this.userCancelPendingWithdrawal = function(transactID, callback) {
      var postBody = null;

      // verify the required parameter 'transactID' is set
      if (transactID === undefined || transactID === null) {
        throw new Error("Missing the required parameter 'transactID' when calling userCancelPendingWithdrawal");
      }
    ...
    /**
     * Callback function to receive the result of the userGetDepositAddressInformation operation.
     * @callback module:api/UserApi~userGetDepositAddressInformationCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} currency Any currency. For all currencies, see <a href=\"#!/Wallet/Wallet_getAssetsConfig\">asset config endpoint</a>
     * @param {String} network The `network` parameter is used to indicate which blockchain you would like to deposit from. The acceptable value in the `network` parameter for each currency can be found from `networks.asset` from `GET /wallet/assets`.
     * @param {module:api/UserApi~userGetDepositAddressInformationCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/DepositAddress}
     */
    this.userGetDepositAddressInformation = function(currency, network, callback) {
      var postBody = null;

      // verify the required parameter 'currency' is set
      if (currency === undefined || currency === null) {
        throw new Error("Missing the required parameter 'currency' when calling userGetDepositAddressInformation");
      }

      // verify the required parameter 'network' is set
      if (network === undefined || network === null) {
        throw new Error("Missing the required parameter 'network' when calling userGetDepositAddressInformation");
      }
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.currency Any currency. For all currencies, see <a href=\"#!/Wallet/Wallet_getAssetsConfig\">asset config endpoint</a>. For all currencies specify \"all\" (default to XBt)
     * @param {Number} opts.count Number of results to fetch. Fetch results from start to start + count. Max: 10,000 rows. (default to 10000)
     * @param {Number} opts.start Starting point for results, integer. Default 0. (default to 0)
     ...
     * @param {Boolean} opts.reverse Start from the latest transaction record. Default true. (default to true)
     ...
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/WalletSummaryRecord>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.currency Any currency. For all currencies, see <a href=\"#!/Wallet/Wallet_getAssetsConfig\">asset config endpoint</a>. For all currencies specify \"all\" (default to XBt)
     * @param {Date} opts.startTime Start time for the summary
     * @param {Date} opts.endTime End time for the summary
     ...
     * data is of type: {@link Array.<module:model/WalletSummaryRecord>}
     */
    this.userGetWalletSummary = function(opts, callback) {
      ...
      var contentTypes = ['application/json', 'application/x-www-form-urlencoded'];
      var accepts = ['application/json', 'application/xml', 'text/xml', 'application/javascript', 'text/javascript'];
      var returnType = [WalletSummaryRecord];
     ...
     * @param {String} opts.memo Destination Memo. If `address`, is specified, Destination Memo can also be specified
