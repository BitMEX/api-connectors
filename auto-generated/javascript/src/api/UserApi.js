...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AccessToken', 'model/Affiliate', 'model/Margin', 'model/Transaction', 'model/User', 'model/UserCommission', 'model/Wallet'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/AccessToken'), require('../model/Affiliate'), require('../model/Margin'), require('../model/Transaction'), require('../model/User'), require('../model/UserCommission'), require('../model/Wallet'));
  } else {
    // Browser globals (root is window)
    if (!root.BitMexApi) {
      root.BitMexApi = {};
    }
    root.BitMexApi.UserApi = factory(root.BitMexApi.ApiClient, root.BitMexApi.AccessToken, root.BitMexApi.Affiliate, root.BitMexApi.Margin, root.BitMexApi.Transaction, root.BitMexApi.User, root.BitMexApi.UserCommission, root.BitMexApi.Wallet);
  }
}(this, function(ApiClient, AccessToken, Affiliate, Margin, Transaction, User, UserCommission, Wallet) {
  'use strict';
