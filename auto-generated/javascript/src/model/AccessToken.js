...
(function(root, factory) {
   ...
   * @param id {String} 
   */
  var exports = function(updated, id) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('authorizedAccounts'))
        obj.authorizedAccounts = ApiClient.convertToType(data['authorizedAccounts'], Object);
  ...
  /**
   * @member {Object} authorizedAccounts
   */
  exports.prototype.authorizedAccounts = undefined;
