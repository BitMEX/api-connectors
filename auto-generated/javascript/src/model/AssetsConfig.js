...
(function(root, factory) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('memoRequired'))
        obj.memoRequired = ApiClient.convertToType(data['memoRequired'], 'Boolean');
  ...
  /**
   * @member {Boolean} memoRequired
   * @default false
   */
  exports.prototype.memoRequired = false;
