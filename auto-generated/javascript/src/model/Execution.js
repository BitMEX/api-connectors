...
(function(root, factory) {
   ...
   */
  var exports = function(orderID, symbol, timestamp) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('execGrossPnl'))
        obj.execGrossPnl = ApiClient.convertToType(data['execGrossPnl'], 'Number');
  ...
  /**
   * @member {Number} execGrossPnl
   */
  exports.prototype.execGrossPnl = undefined;
