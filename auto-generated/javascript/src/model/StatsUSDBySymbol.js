...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BitMexApi.StatsUSDBySymbol = factory(root.BitMexApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The StatsUSDBySymbol model module.
   * @module model/StatsUSDBySymbol
   * @version 1.2.0
   */

  /**
   * Constructs a new <code>StatsUSDBySymbol</code>.
   * @alias module:model/StatsUSDBySymbol
   * @class
   * @param symbol {String} 
   */
  ...
  /**
   * Constructs a <code>StatsUSDBySymbol</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/StatsUSDBySymbol} obj Optional instance to populate.
   * @return {module:model/StatsUSDBySymbol} The populated <code>StatsUSDBySymbol</code> instance.
   */
