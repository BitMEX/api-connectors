...
(function(root, factory) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('firstDepositTimestamp'))
        obj.firstDepositTimestamp = ApiClient.convertToType(data['firstDepositTimestamp'], 'Date');
  ...
  /**
   * @member {Date} firstDepositTimestamp
   */
  exports.prototype.firstDepositTimestamp = undefined;
