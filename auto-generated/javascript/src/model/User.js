...
(function(root, factory) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('pgpPubKeyCreated'))
        obj.pgpPubKeyCreated = ApiClient.convertToType(data['pgpPubKeyCreated'], 'Date');
  ...
  /**
   * @member {Date} pgpPubKeyCreated
   */
  exports.prototype.pgpPubKeyCreated = undefined;
