    ...
    describe('APIKeyApi', function() {
      describe('aPIKeyGet', function() {
        it('should call aPIKeyGet successfully', function(done) {
          // TODO: uncomment, update parameter values for aPIKeyGet call and complete the assertions
          /*
          var opts = {};
          opts.reverse = false;

          instance.aPIKeyGet(opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            ...
            for (let p in dataCtr) {
              let data = dataCtr[p];
              expect(data).to.be.a(BitMexApi.APIKey);
