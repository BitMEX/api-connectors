    ...
    describe('InsuranceApi', function() {
      describe('insuranceGet', function() {
        it('should call insuranceGet successfully', function(done) {
          // TODO: uncomment, update parameter values for insuranceGet call and complete the assertions
          /*
          var opts = {};
          ...
          instance.insuranceGet(opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            ...
            for (let p in dataCtr) {
              let data = dataCtr[p];
              expect(data).to.be.a(BitMexApi.Insurance);
