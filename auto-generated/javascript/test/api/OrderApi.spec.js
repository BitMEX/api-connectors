    ...
    describe('OrderApi', function() {
      ...
      describe('orderAmendBulk', function() {
        it('should call orderAmendBulk successfully', function(done) {
          // TODO: uncomment, update parameter values for orderAmendBulk call and complete the assertions
          /*
          var opts = {};
          opts.orders = "orders_example";

          instance.orderAmendBulk(opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('orderNewBulk', function() {
        it('should call orderNewBulk successfully', function(done) {
          // TODO: uncomment, update parameter values for orderNewBulk call and complete the assertions
          /*
          var opts = {};
          opts.orders = "orders_example";

          instance.orderNewBulk(opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
