    ...
    describe('OrderBookApi', function() {
      describe('orderBookGetL2', function() {
        it('should call orderBookGetL2 successfully', function(done) {
          // TODO: uncomment, update parameter values for orderBookGetL2 call and complete the assertions
          /*
          var symbol = "symbol_example";
          var opts = {};
          opts.depth = 25;

          instance.orderBookGetL2(symbol, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            ...
            for (let p in dataCtr) {
              let data = dataCtr[p];
              expect(data).to.be.a(BitMexApi.OrderBookL2);
