...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UserApi', function() {
      describe('userCancelPendingWithdrawal', function() {
        it('should call userCancelPendingWithdrawal successfully', function(done) {
          // TODO: uncomment, update parameter values for userCancelPendingWithdrawal call and complete the assertions
          /*
          var transactID = "transactID_example";

          instance.userCancelPendingWithdrawal(transactID, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
        ...
        it('should call userGet successfully', function(done) {
          ...
          instance.userGet(function(error, data, response) {
            ...
            expect(data.preferences).to.be.a(BitMexApi.UserPreferences);
              ...
              {
                let dataCtr = data.preferences.favouriteBots;
                expect(dataCtr).to.be.an(Array);
                expect(dataCtr).to.not.be.empty();
                for (let p in dataCtr) {
                  let data = dataCtr[p];
              ...
              expect(data.preferences.hasSetTradingCurrencies).to.be.a('boolean');
              expect(data.preferences.hasSetTradingCurrencies).to.be(false);
              {
              ...
              expect(data.preferences.hidePnlInGuilds).to.be.a('boolean');
              expect(data.preferences.hidePnlInGuilds).to.be(false);
              expect(data.preferences.hideRoiInGuilds).to.be.a('boolean');
              expect(data.preferences.hideRoiInGuilds).to.be(false);
              {
              ...
              expect(data.preferences.mobileLocale).to.be.a('string');
              expect(data.preferences.mobileLocale).to.be("");
              {
              ...
              expect(data.preferences.optionsBeta).to.be.a('boolean');
              expect(data.preferences.optionsBeta).to.be(false);
              ...
              expect(data.preferences.spacingPreference).to.be.a('string');
              expect(data.preferences.spacingPreference).to.be("");
            ...
            expect(data.firstDepositTimestamp).to.be.a(Date);
            expect(data.firstDepositTimestamp).to.be(new Date());
      ...
      describe('userGetDepositAddressInformation', function() {
        it('should call userGetDepositAddressInformation successfully', function(done) {
          // TODO: uncomment, update parameter values for userGetDepositAddressInformation call and complete the assertions
          /*
          var currency = "currency_example";
          var network = "network_example";

          instance.userGetDepositAddressInformation(currency, network, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(BitMexApi.DepositAddress);
            expect(data.address).to.be.a('string');
            expect(data.address).to.be("");
      ...
      describe('userGetWalletSummary', function() {
        it('should call userGetWalletSummary successfully', function(done) {
          ...
          instance.userGetWalletSummary(opts, function(error, data, response) {
            ...
            for (let p in dataCtr) {
              let data = dataCtr[p];
              expect(data).to.be.a(BitMexApi.WalletSummaryRecord);
              expect(data.account).to.be.a('number');
              expect(data.account).to.be(0.0);
              expect(data.currency).to.be.a('string');
              expect(data.currency).to.be("");
              ...
              expect(data.amount).to.be(0.0);
              expect(data.pendingDebit).to.be.a('number');
              expect(data.pendingDebit).to.be(0.0);
              expect(data.realisedPnl).to.be.a('number');
              expect(data.realisedPnl).to.be(0.0);
              expect(data.walletBalance).to.be.a('number');
              expect(data.walletBalance).to.be(0.0);
              expect(data.unrealisedPnl).to.be.a('number');
              expect(data.unrealisedPnl).to.be(0.0);
              expect(data.marginBalance).to.be.a('number');
              expect(data.marginBalance).to.be(0.0);
            }
