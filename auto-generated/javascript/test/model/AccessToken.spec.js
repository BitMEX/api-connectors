...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AccessToken', function() {
      ...
      it('should have the property authorizedAccounts (base name: "authorizedAccounts")', function() {
        // TODO: update the code to test the property authorizedAccounts
        expect(instance).to.have.property('authorizedAccounts');
        // expect(instance.authorizedAccounts).to.be(expectedValueLiteral);
      });
