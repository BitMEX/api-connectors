  ...
  describe('(package)', function() {
    describe('ConnectedUsers', function() {
      ...
      it('should create an instance of ConnectedUsers', function() {
        // TODO: update the code to test ConnectedUsers
      ...
      it('should have the property bots (base name: "bots")', function() {
        // TODO: update the code to test the property bots
        expect(instance).to.have.property('bots');
        // expect(instance.bots).to.be(expectedValueLiteral);
      });
