...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DepositAddress', function() {
      beforeEach(function() {
        instance = new BitMexApi.DepositAddress();
      });

      it('should create an instance of DepositAddress', function() {
        // TODO: update the code to test DepositAddress
        expect(instance).to.be.a(BitMexApi.DepositAddress);
      });
