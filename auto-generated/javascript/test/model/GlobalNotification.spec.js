...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GlobalNotification', function() {
      beforeEach(function() {
        instance = new BitMexApi.GlobalNotification();
      });

      it('should create an instance of GlobalNotification', function() {
        // TODO: update the code to test GlobalNotification
        expect(instance).to.be.a(BitMexApi.GlobalNotification);
      });
      ...
      it('should have the property closable (base name: "closable")', function() {
        // TODO: update the code to test the property closable
        expect(instance).to.have.property('closable');
        // expect(instance.closable).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property waitForVisibility (base name: "waitForVisibility")', function() {
        // TODO: update the code to test the property waitForVisibility
        expect(instance).to.have.property('waitForVisibility');
        // expect(instance.waitForVisibility).to.be(expectedValueLiteral);
      });

      it('should have the property sound (base name: "sound")', function() {
        // TODO: update the code to test the property sound
        expect(instance).to.have.property('sound');
        // expect(instance.sound).to.be(expectedValueLiteral);
      });
