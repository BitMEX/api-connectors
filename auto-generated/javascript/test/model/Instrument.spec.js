...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Instrument', function() {
      ...
      it('should have the property minTick (base name: "minTick")', function() {
        // TODO: update the code to test the property minTick
        expect(instance).to.have.property('minTick');
        // expect(instance.minTick).to.be(expectedValueLiteral);
      });
