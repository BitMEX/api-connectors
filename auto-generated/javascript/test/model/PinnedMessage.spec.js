...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PinnedMessage', function() {
      beforeEach(function() {
        instance = new BitMexApi.PinnedMessage();
      });

      it('should create an instance of PinnedMessage', function() {
        // TODO: update the code to test PinnedMessage
        expect(instance).to.be.a(BitMexApi.PinnedMessage);
      });
      ...
      it('should have the property createdUserId (base name: "createdUserId")', function() {
        // TODO: update the code to test the property createdUserId
        expect(instance).to.have.property('createdUserId');
        // expect(instance.createdUserId).to.be(expectedValueLiteral);
      });

      it('should have the property endedUserId (base name: "endedUserId")', function() {
        // TODO: update the code to test the property endedUserId
        expect(instance).to.have.property('endedUserId');
        // expect(instance.endedUserId).to.be(expectedValueLiteral);
      });
