...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('StakingRecord', function() {
      beforeEach(function() {
        instance = new BitMexApi.StakingRecord();
      });

      it('should create an instance of StakingRecord', function() {
        // TODO: update the code to test StakingRecord
        expect(instance).to.be.a(BitMexApi.StakingRecord);
      });
