...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Trade', function() {
      ...
      it('should have the property trdType (base name: "trdType")', function() {
        // TODO: update the code to test the property trdType
        expect(instance).to.have.property('trdType');
        // expect(instance.trdType).to.be(expectedValueLiteral);
      });
