...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('User', function() {
      ...
      it('should have the property firstDepositTimestamp (base name: "firstDepositTimestamp")', function() {
        // TODO: update the code to test the property firstDepositTimestamp
        expect(instance).to.have.property('firstDepositTimestamp');
        // expect(instance.firstDepositTimestamp).to.be(expectedValueLiteral);
      });
