...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UserEvent', function() {
      beforeEach(function() {
        instance = new BitMexApi.UserEvent();
      });

      it('should create an instance of UserEvent', function() {
        // TODO: update the code to test UserEvent
        expect(instance).to.be.a(BitMexApi.UserEvent);
      });
      ...
      it('should have the property geoipSubRegion (base name: "geoipSubRegion")', function() {
        // TODO: update the code to test the property geoipSubRegion
        expect(instance).to.have.property('geoipSubRegion');
        // expect(instance.geoipSubRegion).to.be(expectedValueLiteral);
      });

      it('should have the property eventMeta (base name: "eventMeta")', function() {
        // TODO: update the code to test the property eventMeta
        expect(instance).to.have.property('eventMeta');
        // expect(instance.eventMeta).to.be(expectedValueLiteral);
      });
