...
@interface SWGGlobalNotificationApi: NSObject <SWGApi>

extern NSString* kSWGGlobalNotificationApiErrorDomain;
extern NSInteger kSWGGlobalNotificationApiMissingParamErrorCode;
...
///
/// @return NSArray<SWGGlobalNotification>*
