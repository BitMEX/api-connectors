...
@interface SWGNotificationApi: NSObject <SWGApi>

extern NSString* kSWGNotificationApiErrorDomain;
extern NSInteger kSWGNotificationApiMissingParamErrorCode;
...
///
/// @return NSArray<SWGNotification>*
