...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"execID", @"clOrdID", @"clOrdLinkID", @"account", @"side", @"lastQty", @"lastPx", @"lastLiquidityInd", @"orderQty", @"price", @"displayQty", @"stopPx", @"pegOffsetValue", @"pegPriceType", @"currency", @"settlCurrency", @"execType", @"ordType", @"timeInForce", @"execInst", @"contingencyType", @"ordStatus", @"triggered", @"workingIndicator", @"ordRejReason", @"leavesQty", @"cumQty", @"avgPx", @"commission", @"tradePublishIndicator", @"text", @"trdMatchID", @"execCost", @"execComm", @"homeNotional", @"foreignNotional", @"transactTime", @"execGrossPnl", @"currentQty", @"avgEntryPrice", @"realisedPnl", @"unrealisedPnl"];
