...
> \Swagger\Client\Model\Execution[] executionGetTradeHistory($target_account_id, $target_account_ids, $symbol, $filter, $columns, $count, $start, $reverse, $start_time, $end_time)
...
$target_account_id = 1.2; // double | AccountId fetching the trade history, must be a paired account with main user.
...
try {
    $result = $apiInstance->executionGetTradeHistory($target_account_id, $target_account_ids, $symbol, $filter, $columns, $count, $start, $reverse, $start_time, $end_time);
    print_r($result);
} catch (Exception $e) {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **target_account_id** | **double**| AccountId fetching the trade history, must be a paired account with main user. | [optional]
