...
$api_instance = new Swagger\Client\Api\InstrumentApi();
...
try {
    $result = $api_instance->instrumentGet($symbol, $filter, $columns, $count, $start, $reverse, $start_time, $end_time);
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $api_instance->instrumentGetActive();
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $api_instance->instrumentGetActiveAndIndices();
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $api_instance->instrumentGetActiveIntervals();
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $api_instance->instrumentGetIndices();
    print_r($result);
} catch (Exception $e) {
