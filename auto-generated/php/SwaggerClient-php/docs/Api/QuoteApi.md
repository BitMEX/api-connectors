...
# **quoteGet**
> \Swagger\Client\Model\Quote[] quoteGet($symbol, $filter, $columns, $count, $start, $reverse, $start_time, $end_time)
...
try {
    $result = $api_instance->quoteGet($symbol, $filter, $columns, $count, $start, $reverse, $start_time, $end_time);
    print_r($result);
} catch (Exception $e) {
...
# **quoteGetBucketed**
> \Swagger\Client\Model\Quote[] quoteGetBucketed($bin_size, $symbol, $filter, $columns, $count, $start, $reverse, $start_time, $end_time)
...
try {
    $result = $api_instance->quoteGetBucketed($bin_size, $symbol, $filter, $columns, $count, $start, $reverse, $start_time, $end_time);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling QuoteApi->quoteGetBucketed: ', $e->getMessage(), PHP_EOL;
}
?>
```
