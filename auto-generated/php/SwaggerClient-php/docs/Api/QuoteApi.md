...
# **quoteGetBucketed**
> \Swagger\Client\Model\Quote[] quoteGetBucketed($bin_size, $partial, $symbol, $filter, $columns, $count, $start, $reverse, $start_time, $end_time)
...
try {
    $result = $apiInstance->quoteGetBucketed($bin_size, $partial, $symbol, $filter, $columns, $count, $start, $reverse, $start_time, $end_time);
    print_r($result);
} catch (Exception $e) {
