...
class ChatApi
{
     ...
     */
    public function chatGet($count = '100', $start = '0', $reverse = 'true', $channel_id = '1')
    {
     ...
     */
    public function chatGetWithHttpInfo($count = '100', $start = '0', $reverse = 'true', $channel_id = '1')
    {
     ...
     */
    public function chatGetAsync($count = '100', $start = '0', $reverse = 'true', $channel_id = '1')
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function chatGetAsyncWithHttpInfo($count = '100', $start = '0', $reverse = 'true', $channel_id = '1')
    {
        $returnType = '\Swagger\Client\Model\Chat[]';
        $request = $this->chatGetRequest($count, $start, $reverse, $channel_id);
     ...
     */
    protected function chatGetRequest($count = '100', $start = '0', $reverse = 'true', $channel_id = '1')
    {
    ...
    /**
     * Operation chatGetPinnedMessage
     *
     * Get pinned message for a channel.
     *
     * @param  double $channel_id channel_id (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\PinnedMessage
     */
    public function chatGetPinnedMessage($channel_id)
    {
        list($response) = $this->chatGetPinnedMessageWithHttpInfo($channel_id);
        return $response;
    }

    /**
     * Operation chatGetPinnedMessageWithHttpInfo
     *
     * Get pinned message for a channel.
     *
     * @param  double $channel_id (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\PinnedMessage, HTTP status code, HTTP response headers (array of strings)
     */
    public function chatGetPinnedMessageWithHttpInfo($channel_id)
    {
        $returnType = '\Swagger\Client\Model\PinnedMessage';
        $request = $this->chatGetPinnedMessageRequest($channel_id);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\PinnedMessage',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation chatGetPinnedMessageAsync
     *
     * Get pinned message for a channel.
     *
     * @param  double $channel_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function chatGetPinnedMessageAsync($channel_id)
    {
        return $this->chatGetPinnedMessageAsyncWithHttpInfo($channel_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation chatGetPinnedMessageAsyncWithHttpInfo
     *
     * Get pinned message for a channel.
     *
     * @param  double $channel_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function chatGetPinnedMessageAsyncWithHttpInfo($channel_id)
    {
        $returnType = '\Swagger\Client\Model\PinnedMessage';
        $request = $this->chatGetPinnedMessageRequest($channel_id);
    ...
    /**
     * Create request for operation 'chatGetPinnedMessage'
     *
     * @param  double $channel_id (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function chatGetPinnedMessageRequest($channel_id)
    {
        // verify the required parameter 'channel_id' is set
        if ($channel_id === null || (is_array($channel_id) && count($channel_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $channel_id when calling chatGetPinnedMessage'
            );
        }

        $resourcePath = '/chat/pinned';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
