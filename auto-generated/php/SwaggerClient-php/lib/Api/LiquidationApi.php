...
class LiquidationApi
{
     ...
     */
    public function liquidationGet($symbol = null, $filter = null, $columns = null, $count = null, $start = null, $reverse = null, $start_time = null, $end_time = null)
    {
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function liquidationGetWithHttpInfo($symbol = null, $filter = null, $columns = null, $count = null, $start = null, $reverse = null, $start_time = null, $end_time = null)
    {
        // parse inputs
        ...
        try {
            ...
            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\Liquidation[]', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\Liquidation[]', $e->getResponseHeaders());
