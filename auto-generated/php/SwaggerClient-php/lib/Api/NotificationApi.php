...
class NotificationApi
{
    ...
    {
        list($response) = $this->notificationGetWithHttpInfo();
        return $response;
    }
     ...
     */
    public function notificationGetWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Model\Notification[]';
        $request = $this->notificationGetRequest();
     ...
     */
    public function notificationGetAsync()
    {
        return $this->notificationGetAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function notificationGetAsyncWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Model\Notification[]';
        $request = $this->notificationGetRequest();
     ...
     */
    protected function notificationGetRequest()
    {
