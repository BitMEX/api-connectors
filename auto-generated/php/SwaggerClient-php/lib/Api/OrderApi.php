...
class OrderApi
{
     ...
     * @param  float $order_qty Optional order quantity in units of the instrument (i.e. contracts, for spot it is the base currency in minor currency (e.g. XBt quantity for XBT)). (optional)
     * @param  double $simple_leaves_qty Deprecated: simple orders are not supported after 2018/10/26 (optional)
     * @param  float $leaves_qty Optional leaves quantity in units of the instrument (i.e. contracts, for spot it is the base currency in minor currency (e.g. XBt quantity for XBT)). Useful for amending partially filled orders. (optional)
     ...
     * @param  double $simple_order_qty Deprecated: simple orders are not supported after 2018/10/26 (optional)
     * @param  float $order_qty Order quantity in units of the instrument (i.e. contracts, for spot it is base currency in minor currency for spot (e.g. XBt quantity for XBT)). (optional)
     * @param  double $price Optional limit price for &#39;Limit&#39;, &#39;StopLimit&#39;, and &#39;LimitIfTouched&#39; orders. (optional)
