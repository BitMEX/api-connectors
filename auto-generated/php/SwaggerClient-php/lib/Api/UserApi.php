...
class UserApi
{
     ...
     *
     * @param  string $currency Options: &#x60;XBt&#x60;, &#x60;USDt&#x60;, &#x60;all&#x60; (optional, default to XBt)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param  string $currency Options: &#x60;XBt&#x60;, &#x60;USDt&#x60; (optional, default to XBt)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return string
     ...
     */
    public function userGetQuoteValueRatio()
    {
        list($response) = $this->userGetQuoteValueRatioWithHttpInfo();
        return $response;
    }
     ...
     */
    public function userGetQuoteValueRatioWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Model\QuoteValueRatio';
        $request = $this->userGetQuoteValueRatioRequest();
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function userGetQuoteValueRatioAsync()
    {
        return $this->userGetQuoteValueRatioAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function userGetQuoteValueRatioAsyncWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Model\QuoteValueRatio';
        $request = $this->userGetQuoteValueRatioRequest();
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function userGetQuoteValueRatioRequest()
    {
     ...
     * @return object
     */
    public function userMinWithdrawalFee($currency = 'XBt', $amount = null)
    {
        list($response) = $this->userMinWithdrawalFeeWithHttpInfo($currency, $amount);
        return $response;
    }
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function userMinWithdrawalFeeWithHttpInfo($currency = 'XBt', $amount = null)
    {
        $returnType = 'object';
        $request = $this->userMinWithdrawalFeeRequest($currency, $amount);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function userMinWithdrawalFeeAsync($currency = 'XBt', $amount = null)
    {
        return $this->userMinWithdrawalFeeAsyncWithHttpInfo($currency, $amount)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function userMinWithdrawalFeeAsyncWithHttpInfo($currency = 'XBt', $amount = null)
    {
        $returnType = 'object';
        $request = $this->userMinWithdrawalFeeRequest($currency, $amount);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function userMinWithdrawalFeeRequest($currency = 'XBt', $amount = null)
    {
     ...
     *
     * @param  string $currency Currency you&#39;re withdrawing. Options: &#x60;XBt&#x60;, &#x60;USDt&#x60; (required)
     * @param  float $amount Amount of withdrawal currency. (required)
     * @param  string $otp_token 2FA token. Required for all external withdrawals. (optional)
     * @param  string $address Destination Address. One of &#x60;address&#x60;, &#x60;addressId&#x60;, &#x60;targetUserId&#x60; has to be specified. (optional)
     * @param  double $address_id ID of the Destination Address. One of &#x60;address&#x60;, &#x60;targetUserId&#x60;, &#x60;targetUserId&#x60; has to be specified. (optional)
     ...
     * @return \Swagger\Client\Model\Transaction
     */
    public function userRequestWithdrawal($currency, $amount, $otp_token = null, $address = null, $address_id = null, $target_user_id = null, $fee = null, $text = null)
    {
        list($response) = $this->userRequestWithdrawalWithHttpInfo($currency, $amount, $otp_token, $address, $address_id, $target_user_id, $fee, $text);
        return $response;
    }
     ...
     * @return array of \Swagger\Client\Model\Transaction, HTTP status code, HTTP response headers (array of strings)
     */
    public function userRequestWithdrawalWithHttpInfo($currency, $amount, $otp_token = null, $address = null, $address_id = null, $target_user_id = null, $fee = null, $text = null)
    {
        $returnType = '\Swagger\Client\Model\Transaction';
        $request = $this->userRequestWithdrawalRequest($currency, $amount, $otp_token, $address, $address_id, $target_user_id, $fee, $text);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function userRequestWithdrawalAsync($currency, $amount, $otp_token = null, $address = null, $address_id = null, $target_user_id = null, $fee = null, $text = null)
    {
        return $this->userRequestWithdrawalAsyncWithHttpInfo($currency, $amount, $otp_token, $address, $address_id, $target_user_id, $fee, $text)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function userRequestWithdrawalAsyncWithHttpInfo($currency, $amount, $otp_token = null, $address = null, $address_id = null, $target_user_id = null, $fee = null, $text = null)
    {
        $returnType = '\Swagger\Client\Model\Transaction';
        $request = $this->userRequestWithdrawalRequest($currency, $amount, $otp_token, $address, $address_id, $target_user_id, $fee, $text);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function userRequestWithdrawalRequest($currency, $amount, $otp_token = null, $address = null, $address_id = null, $target_user_id = null, $fee = null, $text = null)
    {
