...
class Instrument implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'settled_price_adjustment_rate' => 'double',
    ...
    protected static $setters = [
        ...
        'home_notional24h' => 'setHomeNotional24h',
        'foreign_notional24h' => 'setForeignNotional24h',
        ...
        'settled_price_adjustment_rate' => 'setSettledPriceAdjustmentRate',
        'settled_price' => 'setSettledPrice',
        'instant_pnl' => 'setInstantPnl',
        'min_tick' => 'setMinTick',
    ...
    protected static $getters = [
        ...
        'home_notional24h' => 'getHomeNotional24h',
        'foreign_notional24h' => 'getForeignNotional24h',
        ...
        'settled_price_adjustment_rate' => 'getSettledPriceAdjustmentRate',
        'settled_price' => 'getSettledPrice',
        'instant_pnl' => 'getInstantPnl',
        'min_tick' => 'getMinTick',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['listed_settle'] = isset($data['listed_settle']) ? $data['listed_settle'] : null;
        ...
        $this->container['home_notional24h'] = isset($data['home_notional24h']) ? $data['home_notional24h'] : null;
        $this->container['foreign_notional24h'] = isset($data['foreign_notional24h']) ? $data['foreign_notional24h'] : null;
        ...
        $this->container['settled_price_adjustment_rate'] = isset($data['settled_price_adjustment_rate']) ? $data['settled_price_adjustment_rate'] : null;
        $this->container['settled_price'] = isset($data['settled_price']) ? $data['settled_price'] : null;
        $this->container['instant_pnl'] = isset($data['instant_pnl']) ? $data['instant_pnl'] : null;
        $this->container['min_tick'] = isset($data['min_tick']) ? $data['min_tick'] : null;
     ...
     * @return \DateTime
     */
    public function getListedSettle()
    {
        return $this->container['listed_settle'];
    }

    /**
     * Sets listed_settle
     *
     * @param \DateTime $listed_settle listed_settle
     *
     * @return $this
     */
    public function setListedSettle($listed_settle)
    {
        $this->container['listed_settle'] = $listed_settle;
    ...
    /**
     * Gets home_notional24h
     *
     * @return double
     */
    public function getHomeNotional24h()
    {
        return $this->container['home_notional24h'];
    }

    /**
     * Sets home_notional24h
     *
     * @param double $home_notional24h home_notional24h
     *
     * @return $this
     */
    public function setHomeNotional24h($home_notional24h)
    {
        $this->container['home_notional24h'] = $home_notional24h;

        return $this;
    }

    /**
     * Gets foreign_notional24h
     *
     * @return double
     */
    public function getForeignNotional24h()
    {
        return $this->container['foreign_notional24h'];
    }

    /**
     * Sets foreign_notional24h
     *
     * @param double $foreign_notional24h foreign_notional24h
     *
     * @return $this
     */
    public function setForeignNotional24h($foreign_notional24h)
    {
        $this->container['foreign_notional24h'] = $foreign_notional24h;
    ...
    /**
     * Gets settled_price_adjustment_rate
     *
     * @return double
     */
    public function getSettledPriceAdjustmentRate()
    {
        return $this->container['settled_price_adjustment_rate'];
    }

    /**
     * Sets settled_price_adjustment_rate
     *
     * @param double $settled_price_adjustment_rate settled_price_adjustment_rate
     *
     * @return $this
     */
    public function setSettledPriceAdjustmentRate($settled_price_adjustment_rate)
    {
        $this->container['settled_price_adjustment_rate'] = $settled_price_adjustment_rate;
     ...
     * @return bool
     */
    public function getInstantPnl()
    {
        return $this->container['instant_pnl'];
    }

    /**
     * Sets instant_pnl
     *
     * @param bool $instant_pnl instant_pnl
     *
     * @return $this
     */
    public function setInstantPnl($instant_pnl)
    {
        $this->container['instant_pnl'] = $instant_pnl;
     ...
     * Sets min_tick
     *
     * @param double $min_tick min_tick
     *
     * @return $this
     */
