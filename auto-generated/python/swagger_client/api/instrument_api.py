...
class InstrumentApi(object):
    ...
    def instrument_get_usd_volume(self, **kwargs):  # noqa: E501
        """Get a summary of exchange statistics in USD.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.instrument_get_usd_volume(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str symbol: Filter by symbol.
        :param str columns: Array of column names to fetch.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.instrument_get_usd_volume_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.instrument_get_usd_volume_with_http_info(**kwargs)  # noqa: E501
            return data

    def instrument_get_usd_volume_with_http_info(self, **kwargs):  # noqa: E501
        """Get a summary of exchange statistics in USD.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.instrument_get_usd_volume_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['symbol', 'columns']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method instrument_get_usd_volume" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[StatsUSDBySymbol]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
