...
class OrderApi(object):
    ...
    def order_amend(self, **kwargs):  # noqa: E501
        ...
        Send an `orderID` or `origClOrdID` to identify the order you wish to amend.  Both order quantity and price can be amended. Only one `qty` field can be used to amend.  Use the `leavesQty` field to specify how much of the order you wish to remain open. This can be useful if you want to adjust your position's delta by a certain amount, regardless of how much of the order has already filled.  > A `leavesQty` can be used to make a \"Filled\" order live again, if it is received within 60 seconds of the fill.   # noqa: E501
    ...
    def order_cancel_all(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str target_account_ids: AccountIds to cancel all orders, must be a paired account with main user. Also accepts wildcard, [*], this will cancel all orders for all accounts. the authenticated user has order write permissions for.
    ...
    def order_cancel_all_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['target_account_ids', 'symbol', 'filter', 'text']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'target_account_ids' in params:
            form_params.append(('targetAccountIds', params['target_account_ids']))  # noqa: E501
        if 'symbol' in params:
    ...
    def order_new(self, symbol, **kwargs):  # noqa: E501
        ...
        :param str contingency_type: Optional contingency type for use with `clOrdLinkID`. Valid options: OneCancelsTheOther, OneTriggersTheOther.
