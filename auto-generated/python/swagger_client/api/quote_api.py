...
class QuoteApi(object):
    ...
    def quote_get_with_http_info(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.quote_get_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def quote_get_bucketed(self, **kwargs):  # noqa: E501
        ...
        Timestamps returned by our bucketed endpoints are the **end** of the period, indicating when the bucket was written to disk. Some other common systems use the timestamp as the beginning of the period. Please be aware of this when using this endpoint.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.quote_get_bucketed(async_req=True)
        >>> result = thread.get()
    ...
    def quote_get_bucketed_with_http_info(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.quote_get_bucketed_with_http_info(async_req=True)
        >>> result = thread.get()
