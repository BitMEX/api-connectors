...
class UserAffiliatesApi(object):
    ...
    def user_affiliates_get(self, **kwargs):  # noqa: E501
        """Get user's affiliates to a given depth  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.user_affiliates_get(async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.user_affiliates_get_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.user_affiliates_get_with_http_info(**kwargs)  # noqa: E501
            return data

    def user_affiliates_get_with_http_info(self, **kwargs):  # noqa: E501
        """Get user's affiliates to a given depth  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.user_affiliates_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method user_affiliates_get" % key
                )
            params[key] = val
        del params['kwargs']
