...
class NotificationApi(object):
    ...
    def notification_get(self, **kwargs):
        ...
        if kwargs.get('async'):
            return self.notification_get_with_http_info(**kwargs)
        else:
            (data) = self.notification_get_with_http_info(**kwargs)
            return data

    def notification_get_with_http_info(self, **kwargs):
        """
        Get your current notifications.
        This is an upcoming feature and currently does not return data.
        This method makes a synchronous HTTP request by default. To make an
        ...
        return self.api_client.call_api('/notification', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
