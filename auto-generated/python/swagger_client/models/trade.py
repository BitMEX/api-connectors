...
class Trade(object):
    ...
    def __init__(self, timestamp=None, symbol=None, side=None, size=None, price=None, tick_direction=None, trd_match_id=None, gross_value=None, home_notional=None, foreign_notional=None, _configuration=None):  # noqa: E501
