...
SWGError::fromJsonObject(QJsonObject pJson) {
    ::Swagger::setValue(&error, pJson["error"], "SWGError_error", "SWGError_error");
...
SWGError::asJsonObject() {
    ...
    if((error != nullptr) && (error->isSet())){
        toJsonValue(QString("error"), error, obj, QString("SWGError_error"));
    }
...
void
SWGError::setError(SWGError_error* error) {
    this->error = error;
