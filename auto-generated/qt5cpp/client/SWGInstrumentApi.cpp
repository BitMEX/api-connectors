...
void
SWGInstrumentApi::instrument_getCompositeIndex(double account, QString* symbol, QString* filter, QString* columns, SWGNumber* count, SWGNumber* start, bool reverse, QDateTime* start_time, QDateTime* end_time) {
    QString fullPath;
    ...
    if (fullPath.indexOf("?") > 0)
      ...
      fullPath.append("?");
    fullPath.append(QUrl::toPercentEncoding("account"))
        .append("=")
        .append(QUrl::toPercentEncoding(stringValue(account)));
