...
SWGLiquidationApi::SWGLiquidationApi() {}

SWGLiquidationApi::~SWGLiquidationApi() {}

SWGLiquidationApi::SWGLiquidationApi(QString host, QString basePath) {
    this->host = host;
...
SWGLiquidationApi::liquidation_get(QString* symbol, QString* filter, QString* columns, SWGNumber* count, SWGNumber* start, bool reverse, QDateTime* start_time, QDateTime* end_time) {
    ...
    connect(worker,
            ...
            this,
            &SWGLiquidationApi::liquidation_getCallback);

    worker->execute(&input);
}

void
SWGLiquidationApi::liquidation_getCallback(SWGHttpRequestWorker * worker) {
    QString msg;
    ...
    QList<SWGLiquidation*>* output = new QList<SWGLiquidation*>();
    QString json(worker->response);
    QByteArray array (json.toStdString().c_str());
    QJsonDocument doc = QJsonDocument::fromJson(array);
    QJsonArray jsonArray = doc.array();
    auto wrapper = new SWGQObjectWrapper<QList<SWGLiquidation*>*> (output);
    wrapper->deleteLater();
    foreach(QJsonValue obj, jsonArray) {
        SWGLiquidation* o = new SWGLiquidation();
        QJsonObject jv = obj.toObject();
        QJsonObject * ptr = (QJsonObject*)&jv;
        o->fromJsonObject(*ptr);
        auto objwrapper = new SWGQObjectWrapper<SWGLiquidation*> (o);
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        emit liquidation_getSignal(output);
    } else {
        emit liquidation_getSignalE(output, error_type, error_str);
        emit liquidation_getSignalEFull(worker, error_type, error_str);
    }
}
