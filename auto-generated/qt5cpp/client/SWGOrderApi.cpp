...
void
SWGOrderApi::order_cancelAll(QString* target_account_ids, QString* symbol, QString* filter, QString* text) {
    QString fullPath;
    ...
    if (target_account_ids != nullptr) {
        input.add_var("targetAccountIds", *target_account_ids);
    }
    if (symbol != nullptr) {
