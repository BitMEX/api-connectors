...
SWGStakingRecord::SWGStakingRecord(QString json) {
    init();
    this->fromJson(json);
}

SWGStakingRecord::SWGStakingRecord() {
    init();
}
...
SWGStakingRecord*
SWGStakingRecord::fromJson(QString json) {
...
void
SWGStakingRecord::fromJsonObject(QJsonObject pJson) {
...
double
SWGStakingRecord::getAccount() {
    return account;
}
void
SWGStakingRecord::setAccount(double account) {
    this->account = account;
    this->m_account_isSet = true;
}

double
SWGStakingRecord::getAmount() {
    return amount;
}
void
SWGStakingRecord::setAmount(double amount) {
    this->amount = amount;
    this->m_amount_isSet = true;
}

QString*
SWGStakingRecord::getCurrency() {
    return currency;
}
void
SWGStakingRecord::setCurrency(QString* currency) {
