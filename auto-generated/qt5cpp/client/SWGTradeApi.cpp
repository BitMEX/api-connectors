...
SWGTradeApi::trade_get(QString* symbol, QString* filter, QString* columns, SWGNumber* count, SWGNumber* start, bool reverse, QDateTime* start_time, QDateTime* end_time) {
    ...
    connect(worker,
            ...
            this,
            &SWGTradeApi::trade_getCallback);

    worker->execute(&input);
}

void
SWGTradeApi::trade_getCallback(SWGHttpRequestWorker * worker) {
    QString msg;
    ...
    QList<SWGTrade*>* output = new QList<SWGTrade*>();
    QString json(worker->response);
    QByteArray array (json.toStdString().c_str());
    QJsonDocument doc = QJsonDocument::fromJson(array);
    QJsonArray jsonArray = doc.array();
    auto wrapper = new SWGQObjectWrapper<QList<SWGTrade*>*> (output);
    wrapper->deleteLater();
    foreach(QJsonValue obj, jsonArray) {
        SWGTrade* o = new SWGTrade();
        QJsonObject jv = obj.toObject();
        QJsonObject * ptr = (QJsonObject*)&jv;
        o->fromJsonObject(*ptr);
        auto objwrapper = new SWGQObjectWrapper<SWGTrade*> (o);
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        emit trade_getSignal(output);
    } else {
        emit trade_getSignalE(output, error_type, error_str);
        emit trade_getSignalEFull(worker, error_type, error_str);
    }
}
...
SWGTradeApi::trade_getBucketed(QString* bin_size, bool partial, QString* symbol, QString* filter, QString* columns, SWGNumber* count, SWGNumber* start, bool reverse, QDateTime* start_time, QDateTime* end_time) {
    ...
    if (fullPath.indexOf("?") > 0)
      ...
      fullPath.append("?");
    fullPath.append(QUrl::toPercentEncoding("binSize"))
        .append("=")
        .append(QUrl::toPercentEncoding(stringValue(bin_size)));

    if (fullPath.indexOf("?") > 0)
      fullPath.append("&");
    else
      fullPath.append("?");
    fullPath.append(QUrl::toPercentEncoding("partial"))
        .append("=")
        .append(QUrl::toPercentEncoding(stringValue(partial)));
    ...
    connect(worker,
            &SWGHttpRequestWorker::on_execution_finished,
            this,
            &SWGTradeApi::trade_getBucketedCallback);

    worker->execute(&input);
}

void
SWGTradeApi::trade_getBucketedCallback(SWGHttpRequestWorker * worker) {
    QString msg;
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    QList<SWGTradeBin*>* output = new QList<SWGTradeBin*>();
    QString json(worker->response);
    QByteArray array (json.toStdString().c_str());
    QJsonDocument doc = QJsonDocument::fromJson(array);
    QJsonArray jsonArray = doc.array();
    auto wrapper = new SWGQObjectWrapper<QList<SWGTradeBin*>*> (output);
    wrapper->deleteLater();
    foreach(QJsonValue obj, jsonArray) {
        SWGTradeBin* o = new SWGTradeBin();
        QJsonObject jv = obj.toObject();
        QJsonObject * ptr = (QJsonObject*)&jv;
        o->fromJsonObject(*ptr);
        auto objwrapper = new SWGQObjectWrapper<SWGTradeBin*> (o);
        objwrapper->deleteLater();
        output->append(o);
    }
    worker->deleteLater();
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        emit trade_getBucketedSignal(output);
    } else {
        emit trade_getBucketedSignalE(output, error_type, error_str);
        emit trade_getBucketedSignalEFull(worker, error_type, error_str);
    }
}
