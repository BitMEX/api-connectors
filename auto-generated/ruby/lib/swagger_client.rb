...
require 'swagger_client/models/assets_config'
require 'swagger_client/models/assets_config_network_item'
require 'swagger_client/models/chat'
require 'swagger_client/models/chat_channel'
require 'swagger_client/models/collateral_support_agreement'
require 'swagger_client/models/communication_token'
require 'swagger_client/models/connected_users'
require 'swagger_client/models/deposit_address'
...
require 'swagger_client/models/global_notification'
require 'swagger_client/models/guild'
...
require 'swagger_client/api/global_notification_api'
require 'swagger_client/api/guild_api'
...
require 'swagger_client/api/porl_api'
...
require 'swagger_client/api/user_affiliates_api'
require 'swagger_client/api/user_event_api'
