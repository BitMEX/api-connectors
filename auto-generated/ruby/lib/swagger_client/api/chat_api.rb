...
module SwaggerClient
  class ChatApi
    ...
    def chat_get_pinned_message(channel_id, opts = {})
      data, _status_code, _headers = chat_get_pinned_message_with_http_info(channel_id, opts)
      data
    end
    ...
    # @param channel_id 
    # @param [Hash] opts the optional parameters
    # @return [Array<(PinnedMessage, Fixnum, Hash)>] PinnedMessage data, response status code and response headers
    def chat_get_pinned_message_with_http_info(channel_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ChatApi.chat_get_pinned_message ...'
      end
      # verify the required parameter 'channel_id' is set
      if @api_client.config.client_side_validation && channel_id.nil?
        fail ArgumentError, "Missing the required parameter 'channel_id' when calling ChatApi.chat_get_pinned_message"
      end
      # resource path
      local_var_path = '/chat/pinned'
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'PinnedMessage')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ChatApi#chat_get_pinned_message\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Send a chat message.
