...
module SwaggerClient
  class LeaderboardApi
    ...
    def leaderboard_get_name(opts = {})
      data, _status_code, _headers = leaderboard_get_name_with_http_info(opts)
      data
    end
    ...
    def leaderboard_get_name_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: LeaderboardApi.leaderboard_get_name ...'
      end
      # resource path
      local_var_path = '/leaderboard/name'
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: LeaderboardApi#leaderboard_get_name\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
