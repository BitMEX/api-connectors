...
module SwaggerClient
  class OrderApi
    ...
    # @option opts [Integer] :order_qty Optional order quantity in units of the instrument (i.e. contracts, for spot it is the base currency in minor currency (e.g. XBt quantity for XBT)).
    # @option opts [Float] :simple_leaves_qty Deprecated: simple orders are not supported after 2018/10/26
    # @option opts [Integer] :leaves_qty Optional leaves quantity in units of the instrument (i.e. contracts, for spot it is the base currency in minor currency (e.g. XBt quantity for XBT)). Useful for amending partially filled orders.
    ...
    # @option opts [Integer] :count Number of results to fetch. Must be a positive integer. (default to 100)
    # @option opts [Integer] :start Starting point for results. (default to 0)
    ...
    # @option opts [Float] :simple_order_qty Deprecated: simple orders are not supported after 2018/10/26
    # @option opts [Integer] :order_qty Order quantity in units of the instrument (i.e. contracts, for spot it is base currency in minor currency for spot (e.g. XBt quantity for XBT)).
    # @option opts [Float] :price Optional limit price for &#39;Limit&#39;, &#39;StopLimit&#39;, and &#39;LimitIfTouched&#39; orders.
    # @option opts [Integer] :display_qty Optional quantity to display in the book. Use 0 for a fully hidden order.
