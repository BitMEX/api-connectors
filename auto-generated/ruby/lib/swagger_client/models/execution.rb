...
module SwaggerClient
  ...
  class Execution
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'execGrossPnl')
        self.exec_gross_pnl = attributes[:'execGrossPnl']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          exec_gross_pnl == o.exec_gross_pnl &&
    ...
    def hash
      [exec_id, order_id, cl_ord_id, cl_ord_link_id, account, symbol, side, last_qty, last_px, last_liquidity_ind, order_qty, price, display_qty, stop_px, peg_offset_value, peg_price_type, currency, settl_currency, exec_type, ord_type, time_in_force, exec_inst, contingency_type, ord_status, triggered, working_indicator, ord_rej_reason, leaves_qty, cum_qty, avg_px, commission, trade_publish_indicator, text, trd_match_id, exec_cost, exec_comm, home_notional, foreign_notional, transact_time, timestamp, exec_gross_pnl, current_qty, avg_entry_price, realised_pnl, unrealised_pnl].hash
    end
