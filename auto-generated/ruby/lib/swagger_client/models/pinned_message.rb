...
module SwaggerClient
  ...
  class PinnedMessage
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'createdUserId')
        self.created_user_id = attributes[:'createdUserId']
      end

      if attributes.has_key?(:'endedUserId')
        self.ended_user_id = attributes[:'endedUserId']
      end
    end
    ...
    def hash
      [id, channel_id, message_id, created, ended, created_user_id, ended_user_id].hash
    end
