...
module SwaggerClient
  ...
  class Settlement
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'settlementType')
      ...
      if attributes.has_key?(:'bankrupt')
    ...
    def hash
      [timestamp, symbol, settlement_type, settled_price, option_strike_price, option_underlying_price, bankrupt, tax_base, tax_rate].hash
    end
