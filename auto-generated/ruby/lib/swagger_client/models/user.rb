...
module SwaggerClient
  ...
  class User
    ...
    attr_accessor :pgp_pub_key

    attr_accessor :pgp_pub_key_created
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'pgpPubKey')
        self.pgp_pub_key = attributes[:'pgpPubKey']
      end

      if attributes.has_key?(:'pgpPubKeyCreated')
        self.pgp_pub_key_created = attributes[:'pgpPubKeyCreated']
      end
    ...
    def list_invalid_properties
      ...
      if !@pgp_pub_key.nil? && @pgp_pub_key.to_s.length > 16384
        invalid_properties.push('invalid value for "pgp_pub_key", the character length must be smaller than or equal to 16384.')
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] pgp_pub_key Value to be assigned
    def pgp_pub_key=(pgp_pub_key)
      if !pgp_pub_key.nil? && pgp_pub_key.to_s.length > 16384
        fail ArgumentError, 'invalid value for "pgp_pub_key", the character length must be smaller than or equal to 16384.'
      end

      @pgp_pub_key = pgp_pub_key
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          pgp_pub_key_created == o.pgp_pub_key_created &&
          country == o.country &&
    ...
    def hash
      [id, owner_id, firstname, lastname, username, email, phone, created, last_updated, preferences, tfa_enabled, affiliate_id, pgp_pub_key, pgp_pub_key_created, country, geoip_country, geoip_region, typ].hash
    end
