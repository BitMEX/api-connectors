...
module SwaggerClient
  ...
  class User
    ...
    def hash
      [id, firstname, lastname, username, account_name, is_user, email, date_of_birth, phone, created, last_updated, preferences, tfa_enabled, affiliate_id, country, geoip_country, geoip_region, first_trade_timestamp, typ].hash
    end
