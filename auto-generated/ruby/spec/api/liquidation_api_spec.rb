...
# Unit tests for SwaggerClient::LiquidationApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LiquidationApi' do
  before do
    # run before each test
    @instance = SwaggerClient::LiquidationApi.new
  end
  ...
  describe 'test an instance of LiquidationApi' do
    it 'should create an instance of LiquidationApi' do
      expect(@instance).to be_instance_of(SwaggerClient::LiquidationApi)
    end
  end

  # unit tests for liquidation_get
  ...
  describe 'liquidation_get test' do
    it "should work" do
