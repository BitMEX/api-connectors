...
describe 'WalletApi' do
  ...
  # unit tests for wallet_get_assets_config
  # Get Assets Config
  # @param [Hash] opts the optional parameters
  # @return [Array<AssetsConfig>]
  describe 'wallet_get_assets_config test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for wallet_get_networks_config
  # Get Networks Config
  # @param [Hash] opts the optional parameters
  # @return [Array<NetworksConfig>]
  describe 'wallet_get_networks_config test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
