...
# Unit tests for SwaggerClient::AccessToken
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AccessToken' do
  before do
    # run before each test
    @instance = SwaggerClient::AccessToken.new
  end
  ...
  describe 'test an instance of AccessToken' do
    it 'should create an instance of AccessToken' do
      expect(@instance).to be_instance_of(SwaggerClient::AccessToken)
    end
  end
  ...
  describe 'test attribute "authorized_accounts"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
