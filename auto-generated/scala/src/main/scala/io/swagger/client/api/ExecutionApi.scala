...
class ExecutionApi(
   ...
   */
  def executionGet(symbol: Option[String] = None, filter: Option[String] = None, columns: Option[String] = None, count: Option[Number] /* = 100*/, start: Option[Number] /* = 0*/, reverse: Option[Boolean] /* = false*/, startTime: Option[Date] = None, endTime: Option[Date] = None): Option[List[Execution]] = {
  ...
  */
  def executionGetAsync(symbol: Option[String] = None, filter: Option[String] = None, columns: Option[String] = None, count: Option[Number] /* = 100*/, start: Option[Number] /* = 0*/, reverse: Option[Boolean] /* = false*/, startTime: Option[Date] = None, endTime: Option[Date] = None): Future[List[Execution]] = {
   ...
   * @return List[Execution]
   */
  def executionGetTradeHistory(symbol: Option[String] = None, filter: Option[String] = None, columns: Option[String] = None, count: Option[Number] /* = 100*/, start: Option[Number] /* = 0*/, reverse: Option[Boolean] /* = false*/, startTime: Option[Date] = None, endTime: Option[Date] = None): Option[List[Execution]] = {
   ...
   * @return Future(List[Execution])
  */
  def executionGetTradeHistoryAsync(symbol: Option[String] = None, filter: Option[String] = None, columns: Option[String] = None, count: Option[Number] /* = 100*/, start: Option[Number] /* = 0*/, reverse: Option[Boolean] /* = false*/, startTime: Option[Date] = None, endTime: Option[Date] = None): Future[List[Execution]] = {
