...
class QuoteApi(
   ...
   * @return List[Quote]
   */
  def quoteGet(symbol: Option[String] = None, filter: Option[String] = None, columns: Option[String] = None, count: Option[Number] /* = 100*/, start: Option[Number] /* = 0*/, reverse: Option[Boolean] /* = false*/, startTime: Option[Date] = None, endTime: Option[Date] = None): Option[List[Quote]] = {
  ...
  */
  def quoteGetAsync(symbol: Option[String] = None, filter: Option[String] = None, columns: Option[String] = None, count: Option[Number] /* = 100*/, start: Option[Number] /* = 0*/, reverse: Option[Boolean] /* = false*/, startTime: Option[Date] = None, endTime: Option[Date] = None): Future[List[Quote]] = {
   ...
   * @return List[Quote]
   */
  def quoteGetBucketed(binSize: Option[String] /* = 1m*/, partial: Option[Boolean] /* = false*/, symbol: Option[String] = None, filter: Option[String] = None, columns: Option[String] = None, count: Option[Number] /* = 100*/, start: Option[Number] /* = 0*/, reverse: Option[Boolean] /* = false*/, startTime: Option[Date] = None, endTime: Option[Date] = None): Option[List[Quote]] = {
   ...
   * @return Future(List[Quote])
  */
  def quoteGetBucketedAsync(binSize: Option[String] /* = 1m*/, partial: Option[Boolean] /* = false*/, symbol: Option[String] = None, filter: Option[String] = None, columns: Option[String] = None, count: Option[Number] /* = 100*/, start: Option[Number] /* = 0*/, reverse: Option[Boolean] /* = false*/, startTime: Option[Date] = None, endTime: Option[Date] = None): Future[List[Quote]] = {
...
class QuoteApiAsyncHelper(client: TransportClient, config: SwaggerConfig) extends ApiClient(client, config) {
  ...
  def quoteGetBucketed(binSize: Option[String] = Some(1m),
