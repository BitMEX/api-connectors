...
class SettlementApi(
  ...
  val helper = new SettlementApiAsyncHelper(client, config)
   ...
   */
  def settlementGet(symbol: Option[String] = None, filter: Option[String] = None, columns: Option[String] = None, count: Option[Number] /* = 100*/, start: Option[Number] /* = 0*/, reverse: Option[Boolean] /* = false*/, startTime: Option[Date] = None, endTime: Option[Date] = None): Option[List[Settlement]] = {
  ...
  */
  def settlementGetAsync(symbol: Option[String] = None, filter: Option[String] = None, columns: Option[String] = None, count: Option[Number] /* = 100*/, start: Option[Number] /* = 0*/, reverse: Option[Boolean] /* = false*/, startTime: Option[Date] = None, endTime: Option[Date] = None): Future[List[Settlement]] = {
      helper.settlementGet(symbol, filter, columns, count, start, reverse, startTime, endTime)
  }

}

class SettlementApiAsyncHelper(client: TransportClient, config: SwaggerConfig) extends ApiClient(client, config) {
