...
case class UserPreferences (
  ...
  favourites: Option[List[String]] = None,
  favouritesAssets: Option[List[String]] = None,
  favouritesOrdered: Option[List[String]] = None,
  favouriteBots: Option[List[String]] = None,
