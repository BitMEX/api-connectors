...
<a name="orderAmend"></a>
# **orderAmend**
> Order orderAmend(orderID, clOrdID, simpleOrderQty, orderQty, simpleLeavesQty, leavesQty, price, stopPx, pegOffsetValue, text)
...
String clOrdID = "clOrdID_example"; // String | Client Order ID. See POST /order.
