...
public class InsuranceApi {
   ...
   */
  public List<Insurance>  insuranceGet (String symbol, String filter, String columns, BigDecimal count, BigDecimal start, Boolean reverse, Date startTime, Date endTime) throws ApiException {
    ...
    try {
      ...
      if(response != null){
        return (List<Insurance>) ApiInvoker.deserialize(response, "array", Insurance.class);
      }
      else {
        return null;
      }
