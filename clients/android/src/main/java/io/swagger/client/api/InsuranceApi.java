...
public class InsuranceApi {
  ...
  */
  public List<Insurance> insuranceGet (String symbol, String filter, String columns, BigDecimal count, BigDecimal start, Boolean reverse, Date startTime, Date endTime) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
     Object postBody = null;
  

  // create path and map variables
  String path = "/insurance".replaceAll("\\{format\\}","json");
  ...
  "application/json","application/x-www-form-urlencoded"
      ...
      try {
        ...
        if(localVarResponse != null){
           return (List<Insurance>) ApiInvoker.deserialize(localVarResponse, "array", Insurance.class);
        } else {
           return null;
        }
  ...
  */
  public void insuranceGet (String symbol, String filter, String columns, BigDecimal count, BigDecimal start, Boolean reverse, Date startTime, Date endTime, final Response.Listener<List<Insurance>> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
      ...
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((List<Insurance>) ApiInvoker.deserialize(localVarResponse,  "array", Insurance.class));
