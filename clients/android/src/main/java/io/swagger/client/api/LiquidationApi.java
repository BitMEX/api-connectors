...
public class LiquidationApi {
  ...
  */
  public List<Liquidation> liquidationGet (String symbol, String filter, String columns, BigDecimal count, BigDecimal start, Boolean reverse, Date startTime, Date endTime) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
  ...
  "application/json","application/x-www-form-urlencoded"
      ...
      try {
        ...
        if(localVarResponse != null){
           return (List<Liquidation>) ApiInvoker.deserialize(localVarResponse, "array", Liquidation.class);
        } else {
           return null;
        }
  ...
  */
  public void liquidationGet (String symbol, String filter, String columns, BigDecimal count, BigDecimal start, Boolean reverse, Date startTime, Date endTime, final Response.Listener<List<Liquidation>> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
      ...
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((List<Liquidation>) ApiInvoker.deserialize(localVarResponse,  "array", Liquidation.class));
