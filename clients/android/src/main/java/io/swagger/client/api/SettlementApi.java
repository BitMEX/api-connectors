...
public class SettlementApi {
   ...
   */
  public List<Settlement>  settlementGet (String symbol, String filter, String columns, BigDecimal count, BigDecimal start, Boolean reverse, Date startTime, Date endTime) throws ApiException {
    ...
    try {
      ...
      if(response != null){
        return (List<Settlement>) ApiInvoker.deserialize(response, "array", Settlement.class);
      }
      else {
        return null;
      }
