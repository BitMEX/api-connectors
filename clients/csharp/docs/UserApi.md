...
namespace Example
{
    public class UserConfirmPasswordResetExample
    {
        public void main()
        {
            ...
            {
                // Confirm a password reset.
                bool? result = apiInstance.UserConfirmPasswordReset(token, newPassword);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
                Debug.Print("Exception when calling UserApi.UserConfirmPasswordReset: " + e.Message );
            }
        }
    }
}
...
namespace Example
{
    public class UserNewExample
    {
        public void main()
        {
            ...
            var username = username_example;  // string | Desired username. (optional) 
            var firstname = firstname_example;  // string | First name. (optional) 
            var lastname = lastname_example;  // string | Last name. (optional) 
            var acceptsTOS = acceptsTOS_example;  // string | Set to true to indicate acceptance of the Terms of Service (https://www.bitmex.com/terms). (optional) 
            var referrerID = referrerID_example;  // string | Optional Referrer ID. (optional) 
            var tfaType = tfaType_example;  // string | Optional Two-Factor Type. Accepted values: GA, Yubikey, Clef (optional) 
            var tfaToken = tfaToken_example;  // string | Two-Factor Token. (optional) 
            ...
            {
                Debug.Print("Exception when calling UserApi.UserNew: " + e.Message );
            }
        }
    }
}
...
namespace Example
{
    public class UserRequestPasswordResetExample
    {
        public void main()
        {
            ...
            {
                // Request a password reset.
                bool? result = apiInstance.UserRequestPasswordReset(email);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
                Debug.Print("Exception when calling UserApi.UserRequestPasswordReset: " + e.Message );
            }
        }
    }
}
...
namespace Example
{
    public class UserSendVerificationEmailExample
    {
        public void main()
        {
            ...
            {
                // Re-send verification email.
                bool? result = apiInstance.UserSendVerificationEmail(email);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
                Debug.Print("Exception when calling UserApi.UserSendVerificationEmail: " + e.Message );
            }
        }
    }
}
