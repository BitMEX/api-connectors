...
namespace IO.Swagger.Model
{
    ...
    public partial class Leaderboard :  IEquatable<Leaderboard>
    {
        ...
        public Leaderboard(string Name = null, bool? IsRealName = null, bool? IsMe = null, double? Profit = null)
        {
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.IsRealName != null)
                    hash = hash * 59 + this.IsRealName.GetHashCode();
                if (this.IsMe != null)
                    hash = hash * 59 + this.IsMe.GetHashCode();
                if (this.Profit != null)
                    hash = hash * 59 + this.Profit.GetHashCode();
                return hash;
            }
        }
    }
