...
namespace IO.Swagger.Model
{
    ...
    public partial class OrderBook :  IEquatable<OrderBook>, IValidatableObject
    {
        ...
        public OrderBook(string Symbol = default(string), decimal? Level = default(decimal?), decimal? BidSize = default(decimal?), double? BidPrice = default(double?), double? AskPrice = default(double?), decimal? AskSize = default(decimal?), DateTime? Timestamp = default(DateTime?))
        {
