...
namespace IO.Swagger.Api
{
    ...
    public interface ILiquidationApi
    {
        ...
        /// <returns></returns>
        List<Liquidation> LiquidationGet (string symbol = null, string filter = null, string columns = null, double? count = null, double? start = null, bool? reverse = null, DateTime? startTime = null, DateTime? endTime = null);
        ...
        /// <param name="endTime">Ending date filter for results.</param>
        /// <returns></returns>
        System.Threading.Tasks.Task<List<Liquidation>> LiquidationGetAsync (string symbol = null, string filter = null, string columns = null, double? count = null, double? start = null, bool? reverse = null, DateTime? startTime = null, DateTime? endTime = null);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public class LiquidationApi : ILiquidationApi
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LiquidationApi"/> class.
        /// </summary>
        /// <param name="apiClient"> an instance of ApiClient (optional)</param>
        /// <returns></returns>
        public LiquidationApi(ApiClient apiClient = null)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public LiquidationApi(String basePath)
        {
        ...
        /// <param name="endTime">Ending date filter for results.</param> 
        /// <returns></returns>            
        public List<Liquidation> LiquidationGet (string symbol = null, string filter = null, string columns = null, double? count = null, double? start = null, bool? reverse = null, DateTime? startTime = null, DateTime? endTime = null)
        {
            
    
            var path_ = "/liquidation";
            ...
            if (((int)response.StatusCode) >= 400)
                throw new ApiException ((int)response.StatusCode, "Error calling LiquidationGet: " + response.Content, response.Content);
            else if (((int)response.StatusCode) == 0)
                throw new ApiException ((int)response.StatusCode, "Error calling LiquidationGet: " + response.ErrorMessage, response.ErrorMessage);
    
            return (List<Liquidation>) ApiClient.Deserialize(response, typeof(List<Liquidation>));
        }
        ...
        /// <param name="endTime">Ending date filter for results.</param>
        /// <returns></returns>
        public async System.Threading.Tasks.Task<List<Liquidation>> LiquidationGetAsync (string symbol = null, string filter = null, string columns = null, double? count = null, double? start = null, bool? reverse = null, DateTime? startTime = null, DateTime? endTime = null)
        {
