...
class FundingApi {
  ...
  FundingApi([ApiClient apiClient]) {
    if (apiClient != null) {
  ...
  ///
  /// 
  Future<List<Funding>> fundingGet(String symbol, String filter, String columns, Number count, Number start, bool reverse, DateTime startTime, DateTime endTime) {
...
if("null" != endTime)
    ...
    return apiClient.invokeAPI(basePath, path, 'GET', queryParams, postBody, headerParams, formParams, contentType, authNames).then((response) {
      if(response.statusCode >= 400) {
        ...
        return ApiClient.deserialize(response.body, Funding);
      }
      else {
        return null;
      }
