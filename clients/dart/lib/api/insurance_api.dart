...
class InsuranceApi {
  ...
  ///
  /// 
  Future<List<Insurance>> insuranceGet(String symbol, String filter, String columns, Number count, Number start, bool reverse, DateTime startTime, DateTime endTime) {
    ...
    return apiClient.invokeAPI(basePath, path, 'GET', queryParams, postBody, headerParams, formParams, contentType, authNames).then((response) {
      if(response.statusCode >= 400) {
        ...
        return ApiClient.deserialize(response.body, Insurance);
      }
      else {
        return null;
      }
