...
func NewExecutionApi() *ExecutionApi {
...
func NewExecutionApiWithBasePath(basePath string) *ExecutionApi {
	configuration := NewConfiguration()
 ...
 * @return []Execution
 */
func (a ExecutionApi) ExecutionGet(symbol string, filter string, columns string, count float32, start float32, reverse bool, startTime time.Time, endTime time.Time) ([]Execution, *APIResponse, error) {

	var httpMethod = "Get"
	// create path and map variables
	path := a.Configuration.BasePath + "/execution"
...
"text/javascript",
	...
	var successPayload = new([]Execution)
 ...
 * @return []Execution
 */
func (a ExecutionApi) ExecutionGetTradeHistory(symbol string, filter string, columns string, count float32, start float32, reverse bool, startTime time.Time, endTime time.Time) ([]Execution, *APIResponse, error) {

	var httpMethod = "Get"
	// create path and map variables
	path := a.Configuration.BasePath + "/execution/tradeHistory"
