...
func NewFundingApiWithBasePath(basePath string) *FundingApi {
	configuration := NewConfiguration()
 ...
 * @return []Funding
 */
func (a FundingApi) FundingGet(symbol string, filter string, columns string, count float32, start float32, reverse bool, startTime time.Time, endTime time.Time) ([]Funding, *APIResponse, error) {

	var httpMethod = "Get"
	// create path and map variables
	path := a.Configuration.BasePath + "/funding"
...
"text/javascript",
	...
	var successPayload = new([]Funding)
