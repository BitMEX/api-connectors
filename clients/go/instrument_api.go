...
func NewInstrumentApi() *InstrumentApi {
...
func NewInstrumentApiWithBasePath(basePath string) *InstrumentApi {
	configuration := NewConfiguration()
 ...
 * @return []Instrument
 */
func (a InstrumentApi) InstrumentGet(symbol string, filter string, columns string, count float32, start float32, reverse bool, startTime time.Time, endTime time.Time) ([]Instrument, *APIResponse, error) {

	var httpMethod = "Get"
	// create path and map variables
	path := a.Configuration.BasePath + "/instrument"
...
"text/javascript",
	...
	var successPayload = new([]Instrument)
 ...
 * @return []Instrument
 */
func (a InstrumentApi) InstrumentGetActive() ([]Instrument, *APIResponse, error) {

	var httpMethod = "Get"
	// create path and map variables
	path := a.Configuration.BasePath + "/instrument/active"
 ...
 * @return []Instrument
 */
func (a InstrumentApi) InstrumentGetActiveAndIndices() ([]Instrument, *APIResponse, error) {

	var httpMethod = "Get"
	// create path and map variables
	path := a.Configuration.BasePath + "/instrument/activeAndIndices"
 ...
 */
func (a InstrumentApi) InstrumentGetActiveIntervals() (*InstrumentInterval, *APIResponse, error) {

	var httpMethod = "Get"
	// create path and map variables
	path := a.Configuration.BasePath + "/instrument/activeIntervals"
...
"text/javascript",
	...
	var successPayload = new(InstrumentInterval)
	httpResponse, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, fileName, fileBytes)
	if err != nil {
		return successPayload, NewAPIResponse(httpResponse.RawResponse), err
	}
 ...
 * @return []Instrument
 */
func (a InstrumentApi) InstrumentGetIndices() ([]Instrument, *APIResponse, error) {

	var httpMethod = "Get"
	// create path and map variables
	path := a.Configuration.BasePath + "/instrument/indices"
