...
func NewQuoteApiWithBasePath(basePath string) *QuoteApi {
	configuration := NewConfiguration()
 ...
 * @return []Quote
 */
func (a QuoteApi) QuoteGet(symbol string, filter string, columns string, count float32, start float32, reverse bool, startTime time.Time, endTime time.Time) ([]Quote, *APIResponse, error) {

	var httpMethod = "Get"
	// create path and map variables
	path := a.Configuration.BasePath + "/quote"
 ...
 * @return []Quote
 */
func (a QuoteApi) QuoteGetBucketed(binSize string, symbol string, filter string, columns string, count float32, start float32, reverse bool, startTime time.Time, endTime time.Time) ([]Quote, *APIResponse, error) {

	var httpMethod = "Get"
	// create path and map variables
	path := a.Configuration.BasePath + "/quote/bucketed"
