...
func NewSettlementApi() *SettlementApi {
...
func NewSettlementApiWithBasePath(basePath string) *SettlementApi {
	configuration := NewConfiguration()
 ...
 * @return []Settlement
 */
func (a SettlementApi) SettlementGet(symbol string, filter string, columns string, count float32, start float32, reverse bool, startTime time.Time, endTime time.Time) ([]Settlement, *APIResponse, error) {

	var httpMethod = "Get"
	// create path and map variables
	path := a.Configuration.BasePath + "/settlement"
...
"text/javascript",
	...
	var successPayload = new([]Settlement)
