...
class Position {
  ...
  Double prevUnrealisedPnl = null
  Double prevClosePrice = null
  Double realisedCost = null
  Double realisedPnl = null
  Date openingTimestamp = null
  Double openingQty = null
  Double openingCost = null
  Double openingComm = null
  Double openOrderBuyQty = null
  Double openOrderBuyCost = null
  Double openOrderSellQty = null
  Double openOrderSellCost = null
  Double execBuyQty = null
  Double execBuyCost = null
  Double execSellQty = null
  Double execSellCost = null
  Double execQty = null
  ...
  Double currentComm = null
  Double unrealisedCost = null
  Double grossOpenCost = null
  ...
  Double targetExcessMargin = null
