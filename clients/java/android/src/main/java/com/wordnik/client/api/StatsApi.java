...
public class StatsApi {
  ...
  public List<Stats> find () throws ApiException {
    ...
    try {
      ...
      if(response != null){
        return (List<Stats>) ApiInvoker.deserialize(response, "List", Stats.class);
      }
      else {
        return null;
      }
  ...
  //error info- code: 401 reason: "Unauthorized" model: <none>
  //error info- code: 404 reason: "Not Found" model: <none>
  public List<StatsHistory> history () throws ApiException {
    Object postBody = null;
    // create path and map variables
    ...
    try {
      String response = apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, contentType);
      if(response != null){
        return (List<StatsHistory>) ApiInvoker.deserialize(response, "List", StatsHistory.class);
      }
      else {
        return null;
      }
