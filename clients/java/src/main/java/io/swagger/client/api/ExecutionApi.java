...
public class ExecutionApi {
   ...
   */
  public List<Execution> executionGet(String symbol, String filter, String columns, BigDecimal count, BigDecimal start, Boolean reverse, LocalDate startTime, LocalDate endTime) throws ApiException {
    Object localVarPostBody = null;
    
    // create path and map variables
    String localVarPath = "/execution".replaceAll("\\{format\\}","json");
    ...
    GenericType<List<Execution>> localVarReturnType = new GenericType<List<Execution>>() {};
   ...
   * @throws ApiException if fails to make API call
   */
  public List<Execution> executionGetTradeHistory(String symbol, String filter, String columns, BigDecimal count, BigDecimal start, Boolean reverse, LocalDate startTime, LocalDate endTime) throws ApiException {
    Object localVarPostBody = null;
    
    // create path and map variables
    String localVarPath = "/execution/tradeHistory".replaceAll("\\{format\\}","json");
