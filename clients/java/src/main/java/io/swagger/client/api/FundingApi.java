...
public class FundingApi {
   ...
   */
  public List<Funding> fundingGet(String symbol, String filter, String columns, BigDecimal count, BigDecimal start, Boolean reverse, LocalDate startTime, LocalDate endTime) throws ApiException {
    Object localVarPostBody = null;
    
    // create path and map variables
    String localVarPath = "/funding".replaceAll("\\{format\\}","json");
    ...
    GenericType<List<Funding>> localVarReturnType = new GenericType<List<Funding>>() {};
