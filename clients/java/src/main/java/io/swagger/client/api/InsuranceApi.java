...
public class InsuranceApi {
   ...
   */
  public List<Insurance> insuranceGet(String symbol, String filter, String columns, BigDecimal count, BigDecimal start, Boolean reverse, LocalDate startTime, LocalDate endTime) throws ApiException {
    Object localVarPostBody = null;
    
    // create path and map variables
    String localVarPath = "/insurance".replaceAll("\\{format\\}","json");
    ...
    GenericType<List<Insurance>> localVarReturnType = new GenericType<List<Insurance>>() {};
