...
public class LiquidationApi {
  ...
  public LiquidationApi() {
    this(Configuration.getDefaultApiClient());
  }

  public LiquidationApi(ApiClient apiClient) {
   ...
   */
  public List<Liquidation> liquidationGet(String symbol, String filter, String columns, BigDecimal count, BigDecimal start, Boolean reverse, LocalDate startTime, LocalDate endTime) throws ApiException {
    Object localVarPostBody = null;
    
    // create path and map variables
    String localVarPath = "/liquidation".replaceAll("\\{format\\}","json");
    ...
    GenericType<List<Liquidation>> localVarReturnType = new GenericType<List<Liquidation>>() {};
