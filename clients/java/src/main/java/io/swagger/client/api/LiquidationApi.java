...
public class LiquidationApi {
   ...
   */
  public List<Liquidation> liquidationGet (String symbol, String filter, String columns, BigDecimal count, BigDecimal start, Boolean reverse, Date startTime, Date endTime) throws ApiException {
    ...
    TypeRef returnType = new TypeRef<List<Liquidation>>() {};
