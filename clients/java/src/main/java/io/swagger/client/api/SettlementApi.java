...
public class SettlementApi {
   ...
   */
  public List<Settlement> settlementGet(String symbol, String filter, String columns, BigDecimal count, BigDecimal start, Boolean reverse, LocalDate startTime, LocalDate endTime) throws ApiException {
    Object localVarPostBody = null;
    
    // create path and map variables
    String localVarPath = "/settlement".replaceAll("\\{format\\}","json");
    ...
    GenericType<List<Settlement>> localVarReturnType = new GenericType<List<Settlement>>() {};
