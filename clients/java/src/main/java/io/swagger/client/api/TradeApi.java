...
public class TradeApi {
   ...
   */
  public List<Trade> tradeGet(String symbol, String filter, String columns, BigDecimal count, BigDecimal start, Boolean reverse, LocalDate startTime, LocalDate endTime) throws ApiException {
    Object localVarPostBody = null;
    
    // create path and map variables
    String localVarPath = "/trade".replaceAll("\\{format\\}","json");
   ...
   * @throws ApiException if fails to make API call
   */
  public List<TradeBin> tradeGetBucketed(String binSize, String symbol, String filter, String columns, BigDecimal count, BigDecimal start, Boolean reverse, LocalDate startTime, LocalDate endTime) throws ApiException {
    Object localVarPostBody = null;
    
    // create path and map variables
    String localVarPath = "/trade/bucketed".replaceAll("\\{format\\}","json");
    ...
    GenericType<List<TradeBin>> localVarReturnType = new GenericType<List<TradeBin>>() {};
    return apiClient.invokeAPI(localVarPath, "GET", localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
      }
}
