...
public class Instrument   {
  ...
  public String toString()  {
    ...
    sb.append("    hedgerMakerFee: ").append(StringUtil.toIndentedString(hedgerMakerFee)).append("\n");
    sb.append("    hedgerTakerFee: ").append(StringUtil.toIndentedString(hedgerTakerFee)).append("\n");
    sb.append("    hedgerInsuranceFee: ").append(StringUtil.toIndentedString(hedgerInsuranceFee)).append("\n");
