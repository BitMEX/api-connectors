...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/APIKey', 'model/AccessToken', 'model/Affiliate', 'model/Announcement', 'model/Chat', 'model/ChatChannel', 'model/ConnectedUsers', 'model/Error', 'model/ErrorError', 'model/Execution', 'model/Funding', 'model/InlineResponse200', 'model/Instrument', 'model/InstrumentInterval', 'model/Insurance', 'model/Leaderboard', 'model/Liquidation', 'model/Margin', 'model/Order', 'model/OrderBook', 'model/OrderBookL2', 'model/Position', 'model/Quote', 'model/Settlement', 'model/Stats', 'model/StatsHistory', 'model/Trade', 'model/TradeBin', 'model/Transaction', 'model/User', 'model/UserCommission', 'model/UserPreferences', 'model/Wallet', 'model/XAny', 'api/APIKeyApi', 'api/AnnouncementApi', 'api/ChatApi', 'api/ExecutionApi', 'api/FundingApi', 'api/InstrumentApi', 'api/InsuranceApi', 'api/LeaderboardApi', 'api/LiquidationApi', 'api/OrderApi', 'api/OrderBookApi', 'api/PositionApi', 'api/QuoteApi', 'api/SchemaApi', 'api/SettlementApi', 'api/StatsApi', 'api/TradeApi', 'api/UserApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./model/APIKey'), require('./model/AccessToken'), require('./model/Affiliate'), require('./model/Announcement'), require('./model/Chat'), require('./model/ChatChannel'), require('./model/ConnectedUsers'), require('./model/Error'), require('./model/ErrorError'), require('./model/Execution'), require('./model/Funding'), require('./model/InlineResponse200'), require('./model/Instrument'), require('./model/InstrumentInterval'), require('./model/Insurance'), require('./model/Leaderboard'), require('./model/Liquidation'), require('./model/Margin'), require('./model/Order'), require('./model/OrderBook'), require('./model/OrderBookL2'), require('./model/Position'), require('./model/Quote'), require('./model/Settlement'), require('./model/Stats'), require('./model/StatsHistory'), require('./model/Trade'), require('./model/TradeBin'), require('./model/Transaction'), require('./model/User'), require('./model/UserCommission'), require('./model/UserPreferences'), require('./model/Wallet'), require('./model/XAny'), require('./api/APIKeyApi'), require('./api/AnnouncementApi'), require('./api/ChatApi'), require('./api/ExecutionApi'), require('./api/FundingApi'), require('./api/InstrumentApi'), require('./api/InsuranceApi'), require('./api/LeaderboardApi'), require('./api/LiquidationApi'), require('./api/OrderApi'), require('./api/OrderBookApi'), require('./api/PositionApi'), require('./api/QuoteApi'), require('./api/SchemaApi'), require('./api/SettlementApi'), require('./api/StatsApi'), require('./api/TradeApi'), require('./api/UserApi'));
  }
}(function(ApiClient, APIKey, AccessToken, Affiliate, Announcement, Chat, ChatChannel, ConnectedUsers, Error, ErrorError, Execution, Funding, InlineResponse200, Instrument, InstrumentInterval, Insurance, Leaderboard, Liquidation, Margin, Order, OrderBook, OrderBookL2, Position, Quote, Settlement, Stats, StatsHistory, Trade, TradeBin, Transaction, User, UserCommission, UserPreferences, Wallet, XAny, APIKeyApi, AnnouncementApi, ChatApi, ExecutionApi, FundingApi, InstrumentApi, InsuranceApi, LeaderboardApi, LiquidationApi, OrderApi, OrderBookApi, PositionApi, QuoteApi, SchemaApi, SettlementApi, StatsApi, TradeApi, UserApi) {
  'use strict';

  /**
   * _REST_API_for_the_BitMEX_Trading_Platform_Changelog_appapiChangelog_Getting_Started_Fetching_DataAll_REST_endpoints_are_documented_below__You_can_try_out_any_query_right_from_this_interface_Most_table_queries_accept_count_start_and_reverse_params__Set_reversetrue_to_get_rows_newest_first_Additional_documentation_regarding_filters_timestamps_and_authenticationis_available_in__the_main_API_documentation_httpswww_bitmex_comapprestAPI_All_table_data_is_available_via_the__Websocket_appwsAPI__We_highly_recommend_using_the_socket_if_you_wantto_have_the_quickest_possible_data_without_being_subject_to_ratelimits__Return_TypesBy_default_all_data_is_returned_as_JSON__Send__formatcsv_to_get_CSV_data_or__formatxml_to_get_XML_data__Trade_Data_QueriesThis_is_only_a_small_subset_of_what_is_available_to_get_you_started_Fill_in_the_parameters_and_click_the_Try_it_out_button_to_try_any_of_these_queries___Pricing_Data_QuoteQuote_get__Trade_Data_TradeTrade_get__OrderBook_Data_OrderBookOrderBook_getL2__Settlement_Data_SettlementSettlement_get__Exchange_Statistics_StatsStats_historyEvery_function_of_the_BitMEX_com_platform_is_exposed_here_and_documented__Many_more_functions_are_available___All_API_EndpointsClick_to_expand_a_section_.<br>
