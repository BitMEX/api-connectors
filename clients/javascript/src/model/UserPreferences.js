...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BitMexApi.UserPreferences = factory(root.BitMexApi.ApiClient, root.BitMexApi.XAny);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('orderBookBinning')) {
        obj['orderBookBinning'] = XAny.constructFromObject(data['orderBookBinning']);
      }
  ...
  /**
   * @member {module:model/XAny} orderBookBinning
   */
