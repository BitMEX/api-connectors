...
@implementation SWGInsuranceApi

NSString* kSWGInsuranceApiErrorDomain = @"SWGInsuranceApiErrorDomain";
NSInteger kSWGInsuranceApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) insuranceGetWithSymbol: (NSString*) symbol
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"NSArray<SWGInsurance>*"
