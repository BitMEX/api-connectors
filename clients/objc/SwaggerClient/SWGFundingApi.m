...
static SWGFundingApi* singletonAPI = nil;
...
+(SWGFundingApi*) apiWithHeader:(NSString*)headerValue key:(NSString*)key {

    if (singletonAPI == nil) {
        singletonAPI = [[SWGFundingApi alloc] init];
        [singletonAPI addHeader:headerValue forKey:key];
    }
    return singletonAPI;
}

+(SWGFundingApi*) sharedAPI {
...
///
-(NSNumber*) fundingGetWithCompletionBlock: (NSString*) symbol
        ...
        completionHandler: (void (^)(NSArray<SWGFunding>* output, NSError* error))completionBlock { 
    ...
    return [self.apiClient requestWithCompletionBlock: resourcePath
                  ...
                  completionBlock((NSArray<SWGFunding>*)data, error);
              }
          ];
}
