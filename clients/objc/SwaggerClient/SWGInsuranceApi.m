...
static SWGInsuranceApi* singletonAPI = nil;
...
+(SWGInsuranceApi*) apiWithHeader:(NSString*)headerValue key:(NSString*)key {

    if (singletonAPI == nil) {
        singletonAPI = [[SWGInsuranceApi alloc] init];
        [singletonAPI addHeader:headerValue forKey:key];
    }
    return singletonAPI;
}

+(SWGInsuranceApi*) sharedAPI {
...
///
-(NSNumber*) insuranceGetWithCompletionBlock: (NSString*) symbol
        ...
        completionHandler: (void (^)(NSArray<SWGInsurance>* output, NSError* error))completionBlock { 
    ...
    return [self.apiClient requestWithCompletionBlock: resourcePath
                  ...
                  completionBlock((NSArray<SWGInsurance>*)data, error);
              }
          ];
}
