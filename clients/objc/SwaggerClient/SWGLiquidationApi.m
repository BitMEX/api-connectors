...
static SWGLiquidationApi* singletonAPI = nil;
...
+(SWGLiquidationApi*) apiWithHeader:(NSString*)headerValue key:(NSString*)key {

    if (singletonAPI == nil) {
        singletonAPI = [[SWGLiquidationApi alloc] init];
        [singletonAPI addHeader:headerValue forKey:key];
    }
    return singletonAPI;
}

+(SWGLiquidationApi*) sharedAPI {
...
///
-(NSNumber*) liquidationGetWithCompletionBlock: (NSString*) symbol
        ...
        completionHandler: (void (^)(NSArray<SWGLiquidation>* output, NSError* error))completionBlock { 
    ...
    return [self.apiClient requestWithCompletionBlock: resourcePath
                  ...
                  completionBlock((NSArray<SWGLiquidation>*)data, error);
              }
          ];
}
