...
------------- | ------------- | -------------
[**liquidationGet**](SWGLiquidationApi.md#liquidationget) | **GET** /liquidation | Get liquidation orders.


# **liquidationGet**
```objc
-(NSNumber*) liquidationGetWithSymbol: (NSString*) symbol
...
SWGLiquidationApi*apiInstance = [[SWGLiquidationApi alloc] init];

// Get liquidation orders.
[apiInstance liquidationGetWithSymbol:symbol
              filter:filter
              columns:columns
              count:count
              start:start
              ...
              startTime:startTime
              endTime:endTime
          completionHandler: ^(NSArray<SWGLiquidation>* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling SWGLiquidationApi->liquidationGet: %@", error);
                        }
                    }];
```
...
[**NSArray<SWGLiquidation>***](SWGLiquidation.md)
