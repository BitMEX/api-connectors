...
------------- | ------------- | -------------
[**settlementGet**](SWGSettlementApi.md#settlementget) | **GET** /settlement | Get settlement history.


# **settlementGet**
```objc
-(NSURLSessionTask*) settlementGetWithSymbol: (NSString*) symbol
    ...
    endTime: (NSDate*) endTime
        completionHandler: (void (^)(NSArray<SWGSettlement>* output, NSError* error)) handler;
```
...
SWGSettlementApi*apiInstance = [[SWGSettlementApi alloc] init];

// Get settlement history.
[apiInstance settlementGetWithSymbol:symbol
              filter:filter
              columns:columns
              count:count
              start:start
              ...
              startTime:startTime
              endTime:endTime
          completionHandler: ^(NSArray<SWGSettlement>* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling SWGSettlementApi->settlementGet: %@", error);
                        }
                    }];
```
...
[**NSArray<SWGSettlement>***](SWGSettlement.md)
