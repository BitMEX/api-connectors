                      ...
                      completionBlock: ^(NSDictionary *data, NSError *error) {
                         ...
                         if([data isKindOfClass:[NSArray class]]){
                             ...
                             for (NSDictionary* dict in (NSArray*)data) {
                                SWGStats* d = [[SWGStats alloc]initWithValues: dict];
                                [objs addObject:d];
                             }
...
-(NSNumber*) historyWithCompletionBlock: (void (^)(NSArray* output, NSError* error))completionBlock{
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/stats/history", basePath];
                  ...
                  responseContentType: responseContentType
                      completionBlock: ^(NSDictionary *data, NSError *error) {
                         ...
                         if([data isKindOfClass:[NSArray class]]){
                             NSMutableArray * objs = [[NSMutableArray alloc] initWithCapacity:[data count]];
                             for (NSDictionary* dict in (NSArray*)data) {
                                SWGStatsHistory* d = [[SWGStatsHistory alloc]initWithValues: dict];
                                [objs addObject:d];
                             }
                             completionBlock(objs, nil);
                         }
