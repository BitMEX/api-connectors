...
$api_instance = new Swagger\Client\Api\LiquidationApi();
...
try {
    $result = $api_instance->liquidationGet($symbol, $filter, $columns, $count, $start, $reverse, $start_time, $end_time);
    print_r($result);
} catch (Exception $e) {
