...
$api_instance = new Swagger\Client\Api\TradeApi();
...
try {
    $result = $api_instance->tradeGet($symbol, $filter, $columns, $count, $start, $reverse, $start_time, $end_time);
    print_r($result);
} catch (Exception $e) {
...
# **tradeGetBucketed**
> \Swagger\Client\Model\TradeBin[] tradeGetBucketed($bin_size, $symbol, $filter, $columns, $count, $start, $reverse, $start_time, $end_time)
...
try {
    $result = $api_instance->tradeGetBucketed($bin_size, $symbol, $filter, $columns, $count, $start, $reverse, $start_time, $end_time);
    print_r($result);
} catch (Exception $e) {
