...
class InsuranceApi
{
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function insuranceGetWithHttpInfo($symbol = null, $filter = null, $columns = null, $count = null, $start = null, $reverse = null, $start_time = null, $end_time = null)
    {
        // parse inputs
        ...
        try {
            ...
            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\Insurance[]', $httpHeader), $statusCode, $httpHeader);
