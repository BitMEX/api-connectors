...
class ExecutionApi(object):
    ...
    def execution_get(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.execution_get(callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.execution_get_with_http_info(**kwargs)
        else:
            (data) = self.execution_get_with_http_info(**kwargs)
            return data

    def execution_get_with_http_info(self, **kwargs):
        """
        Get all raw executions for your account.
        This returns all raw transactions, which includes order opening and cancelation, and order status changes. It can be quite noisy. More focused information is available at `/execution/tradeHistory`.  You may also use the `filter` param to target your query. Specify an array as a filter value, such as `{\"execType\": [\"Settlement\", \"Trade\"]}` to filter on multiple values.  See [the FIX Spec](http://www.onixs.biz/fix-dictionary/5.0.SP2/msgType_8_8.html) for explanations of these fields. 
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.execution_get_with_http_info(callback=callback_function)
        ...
        resource_path = '/execution'.replace('{format}', 'json')
        path_params = {}
    ...
    def execution_get_trade_history(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.execution_get_trade_history(callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.execution_get_trade_history_with_http_info(**kwargs)
        else:
            (data) = self.execution_get_trade_history_with_http_info(**kwargs)
            return data

    def execution_get_trade_history_with_http_info(self, **kwargs):
        """
        Get all balance-affecting executions. This includes each trade, insurance charge, and settlement.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.execution_get_trade_history_with_http_info(callback=callback_function)
        ...
        resource_path = '/execution/tradeHistory'.replace('{format}', 'json')
        path_params = {}
