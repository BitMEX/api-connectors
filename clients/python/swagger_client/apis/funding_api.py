...
class FundingApi(object):
    ...
    def funding_get(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.funding_get(callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.funding_get_with_http_info(**kwargs)
        else:
            (data) = self.funding_get_with_http_info(**kwargs)
            return data

    def funding_get_with_http_info(self, **kwargs):
        """
        Get funding history.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.funding_get_with_http_info(callback=callback_function)
        ...
        resource_path = '/funding'.replace('{format}', 'json')
        path_params = {}
