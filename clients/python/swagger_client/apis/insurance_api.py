...
class InsuranceApi(object):
    ...
    def insurance_get(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.insurance_get(callback=callback_function)
    ...
    def insurance_get_with_http_info(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.insurance_get_with_http_info(callback=callback_function)
        ...
        resource_path = '/insurance'.replace('{format}', 'json')
        path_params = {}
