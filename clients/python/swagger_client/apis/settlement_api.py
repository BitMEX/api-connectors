...
class SettlementApi(object):
    ...
    def settlement_get(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.settlement_get(callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.settlement_get_with_http_info(**kwargs)
        else:
            (data) = self.settlement_get_with_http_info(**kwargs)
            return data

    def settlement_get_with_http_info(self, **kwargs):
        """
        Get settlement history.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.settlement_get_with_http_info(callback=callback_function)
        ...
        resource_path = '/settlement'.replace('{format}', 'json')
        path_params = {}
