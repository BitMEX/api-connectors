...
class UserApi(object):
    ...
    def user_confirm_email(self, token, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.user_confirm_email_with_http_info(token, **kwargs)
        else:
            (data) = self.user_confirm_email_with_http_info(token, **kwargs)
            return data

    def user_confirm_email_with_http_info(self, token, **kwargs):
        """
        Confirm your email address with a token.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.user_confirm_email_with_http_info(token, callback=callback_function)
