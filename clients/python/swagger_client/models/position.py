...
class Position(object):
    ...
    """
    def __init__(self, account=None, symbol=None, currency=None, underlying=None, quote_currency=None, commission=None, init_margin_req=None, maint_margin_req=None, risk_limit=None, leverage=None, cross_margin=None, deleverage_percentile=None, rebalanced_pnl=None, prev_realised_pnl=None, prev_unrealised_pnl=None, prev_close_price=None, opening_timestamp=None, opening_qty=None, opening_cost=None, opening_comm=None, open_order_buy_qty=None, open_order_buy_cost=None, open_order_buy_premium=None, open_order_sell_qty=None, open_order_sell_cost=None, open_order_sell_premium=None, exec_buy_qty=None, exec_buy_cost=None, exec_sell_qty=None, exec_sell_cost=None, exec_qty=None, exec_cost=None, exec_comm=None, current_timestamp=None, current_qty=None, current_cost=None, current_comm=None, realised_cost=None, unrealised_cost=None, gross_open_cost=None, gross_open_premium=None, gross_exec_cost=None, is_open=None, mark_price=None, mark_value=None, risk_value=None, home_notional=None, foreign_notional=None, pos_state=None, pos_cost=None, pos_cost2=None, pos_cross=None, pos_init=None, pos_comm=None, pos_loss=None, pos_margin=None, pos_maint=None, pos_allowance=None, taxable_margin=None, init_margin=None, maint_margin=None, session_margin=None, target_excess_margin=None, var_margin=None, realised_gross_pnl=None, realised_tax=None, realised_pnl=None, unrealised_gross_pnl=None, long_bankrupt=None, short_bankrupt=None, tax_base=None, indicative_tax_rate=None, indicative_tax=None, unrealised_tax=None, unrealised_pnl=None, unrealised_pnl_pcnt=None, unrealised_roe_pcnt=None, simple_qty=None, simple_cost=None, simple_value=None, simple_pnl=None, simple_pnl_pcnt=None, avg_cost_price=None, avg_entry_price=None, break_even_price=None, margin_call_price=None, liquidation_price=None, bankrupt_price=None, timestamp=None, last_price=None, last_value=None):
        """
