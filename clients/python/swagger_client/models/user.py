...
class User(object):
    ...
    """
    def __init__(self, id=None, owner_id=None, firstname=None, lastname=None, status=None, username=None, email=None, phone=None, country_code=None, created=None, last_updated=None, preferences=None, tfa_enabled=None, affiliate_id=None, pgp_pub_key=None, country=None, disabled=False):
        """
