...
class UserPreferences(object):
    ...
    """
    def __init__(self, announcements_last_seen=None, color_theme=None, currency=None, debug=None, disable_emails=None, hide_confirm_dialogs=None, hide_connection_modal=None, hide_from_leaderboard=False, hide_name_from_leaderboard=True, hide_notifications=None, hide_phone_confirm=None, locale=None, msgs_seen=None, order_book_binning=None, order_book_type=None, order_controls_plus_minus=None, sounds=None, strict_ip_check=False, strict_timeout=True, ticker_group=None, ticker_pinned=None, trade_layout=None):
        """
