...
require 'swagger_client/models/anonymous_model_0'
require 'swagger_client/models/anonymous_model_5'
...
require 'swagger_client/models/role_mapping'
...
require 'swagger_client/models/liquidation_order'
