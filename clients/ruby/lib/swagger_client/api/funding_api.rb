  ...
  class FundingApi
    ...
    def funding_get(opts = {})
      if Configuration.debugging
        Configuration.logger.debug "Calling API: FundingApi#funding_get ..."
      end
      
      # resource path
      path = "/funding".sub('{format}','json')
      ...
      if Configuration.debugging
        Configuration.logger.debug "API called: FundingApi#funding_get. Result: #{result.inspect}"
      end
      return result
    end
  end
