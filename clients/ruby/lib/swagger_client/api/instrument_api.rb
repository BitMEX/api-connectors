  ...
  class InstrumentApi
    ...
    def instrument_get(opts = {})
      if Configuration.debugging
        Configuration.logger.debug "Calling API: InstrumentApi#instrument_get ..."
      end
      ...
      if Configuration.debugging
        Configuration.logger.debug "API called: InstrumentApi#instrument_get. Result: #{result.inspect}"
      end
      return result
    end
