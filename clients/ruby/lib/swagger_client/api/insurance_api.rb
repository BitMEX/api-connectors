  ...
  class InsuranceApi
    ...
    def insurance_get(opts = {})
      if Configuration.debugging
        Configuration.logger.debug "Calling API: InsuranceApi#insurance_get ..."
      end
      
      # resource path
      path = "/insurance".sub('{format}','json')
      ...
      if Configuration.debugging
        Configuration.logger.debug "API called: InsuranceApi#insurance_get. Result: #{result.inspect}"
      end
      return result
    end
  end
