  ...
  class OrderBookApi
    ...
    def order_book_get(symbol, opts = {})
      if Configuration.debugging
        Configuration.logger.debug "Calling API: OrderBookApi#order_book_get ..."
      end
      
      # verify the required parameter 'symbol' is set
      fail "Missing the required parameter 'symbol' when calling order_book_get" if symbol.nil?
      ...
      if Configuration.debugging
        Configuration.logger.debug "API called: OrderBookApi#order_book_get. Result: #{result.inspect}"
      end
      return result
    end
    ...
    def order_book_get_l2(symbol, opts = {})
      if Configuration.debugging
        Configuration.logger.debug "Calling API: OrderBookApi#order_book_get_l2 ..."
      end
      
      # verify the required parameter 'symbol' is set
      fail "Missing the required parameter 'symbol' when calling order_book_get_l2" if symbol.nil?
      
      # resource path
      path = "/orderBook/L2".sub('{format}','json')
      ...
      if Configuration.debugging
        Configuration.logger.debug "API called: OrderBookApi#order_book_get_l2. Result: #{result.inspect}"
      end
      return result
    end
  end
