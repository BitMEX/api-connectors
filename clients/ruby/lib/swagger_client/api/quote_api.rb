  ...
  class QuoteApi
    ...
    def quote_get(opts = {})
      if Configuration.debugging
        Configuration.logger.debug "Calling API: QuoteApi#quote_get ..."
      end
      
      # resource path
      path = "/quote".sub('{format}','json')
      ...
      if Configuration.debugging
        Configuration.logger.debug "API called: QuoteApi#quote_get. Result: #{result.inspect}"
      end
      return result
    end
    ...
    def quote_get_bucketed(opts = {})
      if Configuration.debugging
        Configuration.logger.debug "Calling API: QuoteApi#quote_get_bucketed ..."
      end
      ...
      result = @api_client.call_api(:GET, path,
        ...
        :return_type => 'Array<Quote>')
      if Configuration.debugging
        Configuration.logger.debug "API called: QuoteApi#quote_get_bucketed. Result: #{result.inspect}"
      end
      return result
    end
  end
