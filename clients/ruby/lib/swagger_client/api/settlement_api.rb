  ...
  class SettlementApi
    ...
    def settlement_get(opts = {})
      if Configuration.debugging
        Configuration.logger.debug "Calling API: SettlementApi#settlement_get ..."
      end
      
      # resource path
      path = "/settlement".sub('{format}','json')
      ...
      if Configuration.debugging
        Configuration.logger.debug "API called: SettlementApi#settlement_get. Result: #{result.inspect}"
      end
      return result
    end
  end
