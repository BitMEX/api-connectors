...
module SwaggerClient
  class UserApi
    ...
    def user_cancel_withdrawal_with_http_info(token, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'token' when calling UserApi.user_cancel_withdrawal" if token.nil?
      # resource path
      local_var_path = "/user/cancelWithdrawal".sub('{format}','json')
    ...
    def user_check_referral_code_with_http_info(opts = {})
      ...
      # resource path
      local_var_path = "/user/checkReferralCode".sub('{format}','json')
    ...
    def user_confirm_withdrawal_with_http_info(token, opts = {})
      ...
      # verify the required parameter 'token' is set
      fail ArgumentError, "Missing the required parameter 'token' when calling UserApi.user_confirm_withdrawal" if token.nil?
      # resource path
      local_var_path = "/user/confirmWithdrawal".sub('{format}','json')
    ...
    def user_disable_tfa_with_http_info(token, opts = {})
      ...
      # verify the required parameter 'token' is set
      fail ArgumentError, "Missing the required parameter 'token' when calling UserApi.user_disable_tfa" if token.nil?
      # resource path
      local_var_path = "/user/disableTFA".sub('{format}','json')
    ...
    # 
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<Affiliate>, Fixnum, Hash)>] Array<Affiliate> data, response status code and response headers
    def user_get_affiliate_status_with_http_info(opts = {})
      ...
      # resource path
      local_var_path = "/user/affiliateStatus".sub('{format}','json')
    ...
    def user_get_commission_with_http_info(opts = {})
      ...
      # resource path
      local_var_path = "/user/commission".sub('{format}','json')
    ...
    def user_get_deposit_address_with_http_info(opts = {})
      ...
      # resource path
      local_var_path = "/user/depositAddress".sub('{format}','json')
    ...
    def user_get_margin_with_http_info(opts = {})
      ...
      # resource path
      local_var_path = "/user/margin".sub('{format}','json')
    ...
    def user_get_wallet_history_with_http_info(opts = {})
      ...
      # resource path
      local_var_path = "/user/walletHistory".sub('{format}','json')
    ...
    def user_logout_all_with_http_info(opts = {})
      ...
      # resource path
      local_var_path = "/user/logoutAll".sub('{format}','json')
    ...
    def user_request_enable_tfa_with_http_info(opts = {})
      ...
      # resource path
      local_var_path = "/user/requestEnableTFA".sub('{format}','json')
    ...
    def user_request_withdrawal_with_http_info(currency, amount, address, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'currency' when calling UserApi.user_request_withdrawal" if currency.nil?
      # verify the required parameter 'amount' is set
      fail ArgumentError, "Missing the required parameter 'amount' when calling UserApi.user_request_withdrawal" if amount.nil?
      # verify the required parameter 'address' is set
      fail ArgumentError, "Missing the required parameter 'address' when calling UserApi.user_request_withdrawal" if address.nil?
      # resource path
      local_var_path = "/user/requestWithdrawal".sub('{format}','json')
    ...
    def user_save_preferences_with_http_info(prefs, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'prefs' when calling UserApi.user_save_preferences" if prefs.nil?
      # resource path
      local_var_path = "/user/preferences".sub('{format}','json')
