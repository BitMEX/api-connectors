...
module SwaggerClient
  ...
  class ApiKey
    ...
    def valid?
      ...
      return false if @secret.to_s.length < 
      return false if @name.nil?
      return false if @name.to_s.length < 
      return false if @nonce.nil?
      return false if @cidr.to_s.length < 
    ...
    def secret=(secret)
      ...
      if secret.to_s.length < 
        fail ArgumentError, "invalid value for 'secret', the character length must be great than or equal to ."
      end
    ...
    def cidr=(cidr)
      ...
      if cidr.to_s.length < 
        fail ArgumentError, "invalid value for 'cidr', the character length must be great than or equal to ."
      end
