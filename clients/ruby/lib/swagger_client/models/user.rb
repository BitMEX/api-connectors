...
module SwaggerClient
  ...
  class User
    ...
    def valid?
      ...
      return false if @affiliate_id.to_s.length < 
      return false if @pgp_pub_key.to_s.length < 
    ...
    def affiliate_id=(affiliate_id)
      if affiliate_id.nil?
        fail ArgumentError, "affiliate_id cannot be nil"
      end

      if affiliate_id.to_s.length < 
        fail ArgumentError, "invalid value for 'affiliate_id', the character length must be great than or equal to ."
      end
    ...
    def pgp_pub_key=(pgp_pub_key)
      if pgp_pub_key.nil?
        fail ArgumentError, "pgp_pub_key cannot be nil"
      end

      if pgp_pub_key.to_s.length < 
        fail ArgumentError, "invalid value for 'pgp_pub_key', the character length must be great than or equal to ."
      end
    ...
    def country=(country)
      ...
      if country.to_s.length < 
        fail ArgumentError, "invalid value for 'country', the character length must be great than or equal to ."
      end
