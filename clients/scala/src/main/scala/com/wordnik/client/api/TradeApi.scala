...
class TradeApi {
  ...
  def get (symbol: String, filter: Any, columns: List[String], start: Double, reverse: Boolean, startTime: Date, endTime: Date, count: Double= 100) : Option[List[Trade]]= {
  ...
  def getBucketed (symbol: String, filter: Any, columns: List[String], start: Double, reverse: Boolean, startTime: Date, endTime: Date, binSize: String= "1m", count: Double= 100) : Option[List[TradeBin]]= {
    // create path and map variables
