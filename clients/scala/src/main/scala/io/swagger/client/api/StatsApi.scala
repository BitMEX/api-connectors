...
class StatsApi(
  ...
  def statsGet(): Option[List[Stats]] = {
    val await = Try(Await.result(statsGetAsync(), Duration.Inf))
    await match {
  ...
  */
  ...
  def statsHistory(): Option[List[StatsHistory]] = {
    val await = Try(Await.result(statsHistoryAsync(), Duration.Inf))
    await match {
      case Success(i) => Some(await.get)
      case Failure(t) => None
    }
  ...
  */
  ...
  def statsHistoryUSD(): Option[List[StatsUSD]] = {
    val await = Try(Await.result(statsHistoryUSDAsync(), Duration.Inf))
    await match {
      case Success(i) => Some(await.get)
      case Failure(t) => None
    }
...
class StatsApiAsyncHelper(client: TransportClient, config: SwaggerConfig) extends ApiClient(client, config) {

  def statsGet()(implicit reader: ClientResponseReader[List[Stats]]): Future[List[Stats]] = {
  ...
  def statsHistory()(implicit reader: ClientResponseReader[List[StatsHistory]]): Future[List[StatsHistory]] = {
    // create path and map variables
  ...
  def statsHistoryUSD()(implicit reader: ClientResponseReader[List[StatsUSD]]): Future[List[StatsUSD]] = {
    // create path and map variables
    val path = (addFmt("/stats/historyUSD"))
