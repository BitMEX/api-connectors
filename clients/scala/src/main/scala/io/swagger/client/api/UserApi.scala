...
class UserApi(val defBasePath: String = "https://localhost/api/v1",
   ...
   * @return User
   */
  def userUpdateMe (firstname: String, lastname: String, oldPassword: String, newPassword: String, newPasswordConfirm: String, country: String, pgpPubKey: String) : Option[User] = {
    // create path and map variables
    val path = "/user".replaceAll("\\{format\\}","json")
   ...
   * @return User
   */
  def userNewUser (email: String, password: String, username: String, firstname: String, lastname: String, acceptsTOS: String, referrerID: String, country: String) : Option[User] = {
    // create path and map variables
    val path = "/user".replaceAll("\\{format\\}","json")
   ...
   * @return Margin
   */
  def userGetMargin () : Option[Margin] = {
    // create path and map variables
   ...
   * @return Boolean
   */
  def userRequestEnableTFA (_type: String, token: String) : Option[Boolean] = {
    // create path and map variables
   ...
   */
  def userGetWalletHistory () : Option[List[Transaction]] = {
    // create path and map variables
