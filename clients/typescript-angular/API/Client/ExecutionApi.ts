...
namespace API.Client {
    ...
    export class ExecutionApi {
         ...
         */
        public executionGet (symbol?: string, filter?: string, columns?: string, count?: number, start?: number, reverse?: boolean, startTime?: date, endTime?: date, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<Execution>> {
            const path = this.basePath + '/execution';
         ...
         * @param endTime Ending date filter for results.
         */
        public executionGetTradeHistory (symbol?: string, filter?: string, columns?: string, count?: number, start?: number, reverse?: boolean, startTime?: date, endTime?: date, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<Execution>> {
            const path = this.basePath + '/execution/tradeHistory';
