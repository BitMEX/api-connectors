...
namespace API.Client {
    ...
    export class InsuranceApi {
         ...
         */
        public insuranceGet (symbol?: string, filter?: string, columns?: string, count?: number, start?: number, reverse?: boolean, startTime?: date, endTime?: date, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<Insurance>> {
            const path = this.basePath + '/insurance';
