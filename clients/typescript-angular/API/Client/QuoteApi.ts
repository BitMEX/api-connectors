...
namespace API.Client {
    ...
    export class QuoteApi {
         ...
         */
        public quoteGet (symbol?: string, filter?: string, columns?: string, count?: number, start?: number, reverse?: boolean, startTime?: date, endTime?: date, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<Quote>> {
            const path = this.basePath + '/quote';
         ...
         * @param endTime Ending date filter for results.
         */
        public quoteGetBucketed (binSize?: string, symbol?: string, filter?: string, columns?: string, count?: number, start?: number, reverse?: boolean, startTime?: date, endTime?: date, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<Quote>> {
            const path = this.basePath + '/quote/bucketed';
