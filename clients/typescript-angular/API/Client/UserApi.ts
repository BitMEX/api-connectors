...
namespace API.Client {
    ...
    export class UserApi {
         ...
         * 
         */
        public userGet (extraHttpRequestParams?: any ) : ng.IHttpPromise<User> {
         ...
         */
        public userUpdate (firstname?: string, lastname?: string, oldPassword?: string, newPassword?: string, newPasswordConfirm?: string, username?: string, country?: string, pgpPubKey?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<User> {
            const path = this.basePath + '/user';
         ...
         */
        public userNew (email: string, password: string, country: string, username?: string, firstname?: string, lastname?: string, acceptsTOS?: string, referrerID?: string, tfaType?: string, tfaToken?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<User> {
            const path = this.basePath + '/user';
         ...
         * 
         */
        public userLogoutAll (extraHttpRequestParams?: any ) : ng.IHttpPromise<number> {
         ...
         * @param currency 
         */
        public userGetMargin (currency?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Margin> {
         ...
         * @param type Two-factor auth type. Supported types: &#39;GA&#39; (Google Authenticator)
         */
        public userRequestEnableTFA (type?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<boolean> {
         ...
         * @param currency 
         */
        public userGetWalletHistory (currency?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<Transaction>> {
