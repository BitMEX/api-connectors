...
public class InstrumentApi  {
   private final InstrumentApiService delegate = InstrumentApiServiceFactory.getInstrumentApi();
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 404, message = "Not Found", response = Instrument.class, responseContainer = "List") })
    public Response instrumentGetActive(@Context SecurityContext securityContext)
    throws NotFoundException {
        return delegate.instrumentGetActive(securityContext);
    }
    @GET
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 404, message = "Not Found", response = Instrument.class, responseContainer = "List") })
    public Response instrumentGetActiveAndIndices(@Context SecurityContext securityContext)
    throws NotFoundException {
        return delegate.instrumentGetActiveAndIndices(securityContext);
    }
    @GET
    ...
    public Response instrumentGetActiveIntervals(@Context SecurityContext securityContext)
    throws NotFoundException {
        return delegate.instrumentGetActiveIntervals(securityContext);
    }
    @GET
    @Path("/indices")
    @Consumes({ "application/json", "application/x-www-form-urlencoded" })
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 404, message = "Not Found", response = Instrument.class, responseContainer = "List") })
    public Response instrumentGetIndices(@Context SecurityContext securityContext)
    throws NotFoundException {
        return delegate.instrumentGetIndices(securityContext);
    }
}
