...
public abstract class InsuranceApiService {
      ...
      public abstract Response insuranceGet(String symbol,String filter,String columns,BigDecimal count,BigDecimal start,Boolean reverse,Date startTime,Date endTime)
