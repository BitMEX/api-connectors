...
public class Instrument   {
  ...
  /**
   **/
  public Instrument listing(Date listing) {
  ...
  /**
   **/
  public Instrument front(Date front) {
    this.front = front;
    return this;
  }
  ...
  /**
   **/
  public Instrument expiry(Date expiry) {
    this.expiry = expiry;
    return this;
  }
  ...
  /**
   **/
  public Instrument settle(Date settle) {
    this.settle = settle;
    return this;
  }
  ...
  /**
   **/
  public Instrument relistInterval(Date relistInterval) {
  ...
  /**
   **/
  public Instrument calcInterval(Date calcInterval) {
  ...
  /**
   **/
  public Instrument publishInterval(Date publishInterval) {
  ...
  /**
   **/
  public Instrument publishTime(Date publishTime) {
  ...
  /**
   **/
  public Instrument fundingTimestamp(Date fundingTimestamp) {
  ...
  /**
   **/
  public Instrument fundingInterval(Date fundingInterval) {
  ...
  /**
   **/
  public Instrument rebalanceTimestamp(Date rebalanceTimestamp) {
  ...
  /**
   **/
  public Instrument rebalanceInterval(Date rebalanceInterval) {
  ...
  /**
   **/
  public Instrument openingTimestamp(Date openingTimestamp) {
  ...
  /**
   **/
  public Instrument closingTimestamp(Date closingTimestamp) {
  ...
  /**
   **/
  public Instrument sessionInterval(Date sessionInterval) {
  ...
  /**
   **/
  public Instrument timestamp(Date timestamp) {
