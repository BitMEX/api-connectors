...
public class InstrumentApiServiceImpl extends InstrumentApiService {
      ...
      @Override
      public Response instrumentGet(String symbol,String filter,String columns,BigDecimal count,BigDecimal start,Boolean reverse,Date startTime,Date endTime)
