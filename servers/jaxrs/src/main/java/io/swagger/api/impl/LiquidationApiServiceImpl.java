...
public class LiquidationApiServiceImpl extends LiquidationApiService {
    @Override
    public Response liquidationGet(String symbol, String filter, String columns, BigDecimal count, BigDecimal start, Boolean reverse, Date startTime, Date endTime, SecurityContext securityContext) throws NotFoundException {
        // do some magic!
