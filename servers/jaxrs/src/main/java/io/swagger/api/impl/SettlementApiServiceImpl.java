...
public class SettlementApiServiceImpl extends SettlementApiService {
    @Override
    public Response settlementGet(String symbol, String filter, String columns, BigDecimal count, BigDecimal start, Boolean reverse, Date startTime, Date endTime, SecurityContext securityContext) throws NotFoundException {
        // do some magic!
