...
MyApp.add_route('POST', '/api/v1/apiKey/disable', {
  "resourcePath" => "/ApiKey",
...
MyApp.add_route('POST', '/api/v1/apiKey/enable', {
  "resourcePath" => "/ApiKey",
...
MyApp.add_route('GET', '/api/v1/apiKey', {
  "resourcePath" => "/ApiKey",
...
MyApp.add_route('POST', '/api/v1/apiKey', {
  "resourcePath" => "/ApiKey",
...
MyApp.add_route('DELETE', '/api/v1/apiKey', {
  "resourcePath" => "/ApiKey",
