...
MyApp.add_route('POST', '/api/v1/user/cancelWithdrawal', {
  "resourcePath" => "/User",
...
MyApp.add_route('GET', '/api/v1/user/checkReferralCode', {
  "resourcePath" => "/User",
...
MyApp.add_route('POST', '/api/v1/user/confirmEmail', {
  "resourcePath" => "/User",
...
MyApp.add_route('POST', '/api/v1/user/confirmEnableTFA', {
  "resourcePath" => "/User",
...
MyApp.add_route('POST', '/api/v1/user/confirmPasswordReset', {
  "resourcePath" => "/User",
...
MyApp.add_route('POST', '/api/v1/user/confirmWithdrawal', {
  "resourcePath" => "/User",
...
MyApp.add_route('POST', '/api/v1/user/disableTFA', {
  "resourcePath" => "/User",
...
MyApp.add_route('GET', '/api/v1/user', {
  "resourcePath" => "/User",
...
MyApp.add_route('GET', '/api/v1/user/affiliateStatus', {
  "resourcePath" => "/User",
...
MyApp.add_route('GET', '/api/v1/user/commission', {
  "resourcePath" => "/User",
...
MyApp.add_route('GET', '/api/v1/user/depositAddress', {
  "resourcePath" => "/User",
...
MyApp.add_route('GET', '/api/v1/user/margin', {
  "resourcePath" => "/User",
...
MyApp.add_route('GET', '/api/v1/user/walletHistory', {
  "resourcePath" => "/User",
...
MyApp.add_route('POST', '/api/v1/user/login', {
  "resourcePath" => "/User",
...
MyApp.add_route('POST', '/api/v1/user/logout', {
  "resourcePath" => "/User",
...
MyApp.add_route('POST', '/api/v1/user/logoutAll', {
  "resourcePath" => "/User",
...
MyApp.add_route('POST', '/api/v1/user', {
  "resourcePath" => "/User",
...
MyApp.add_route('POST', '/api/v1/user/requestEnableTFA', {
  "resourcePath" => "/User",
...
MyApp.add_route('POST', '/api/v1/user/requestPasswordReset', {
  "resourcePath" => "/User",
...
MyApp.add_route('POST', '/api/v1/user/requestWithdrawal', {
  "resourcePath" => "/User",
...
MyApp.add_route('POST', '/api/v1/user/preferences', {
  "resourcePath" => "/User",
...
MyApp.add_route('POST', '/api/v1/user/resendVerificationEmail', {
  "resourcePath" => "/User",
...
MyApp.add_route('PUT', '/api/v1/user', {
  "resourcePath" => "/User",
