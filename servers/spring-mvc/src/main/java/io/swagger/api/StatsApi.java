...
public class StatsApi {
  ...
  @ApiOperation(value = "Get exchange-wide and per-series turnover and volume statistics.", notes = "", response = Stats.class, responseContainer = "List")
  @ApiResponses(value = { 
  ...
  @ApiOperation(value = "Get historical exchange-wide and per-series turnover and volume statistics.", notes = "", response = StatsHistory.class, responseContainer = "List")
  @ApiResponses(value = { 
    @ApiResponse(code = 200, message = "Request was successful"),
    @ApiResponse(code = 400, message = "Parameter Error"),
    @ApiResponse(code = 401, message = "Unauthorized"),
