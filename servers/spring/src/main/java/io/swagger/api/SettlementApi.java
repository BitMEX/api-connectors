...
public interface SettlementApi {
    ...
    @ApiOperation(value = "Get settlement history.", notes = "", response = Settlement.class, responseContainer = "List", tags={ "Settlement", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Request was successful", response = Settlement.class),
        @ApiResponse(code = 400, message = "Parameter Error", response = Settlement.class),
        @ApiResponse(code = 401, message = "Unauthorized", response = Settlement.class),
        @ApiResponse(code = 404, message = "Not Found", response = Settlement.class) })
